...
May only contest objectives, not control them.</description>
    </rule>
...
Summoned units remain on the battlefield until the end phase of the turn in which they are summoned. In the end of the rally phase, after formations have attempted to rally, all summoned units in the formation are removed from the board and placed back into the Daemon Pool unless the formation has a unit with Daemonic Focus. Greater Daemons that are returned to the Daemon Pool keep the same DC they had when they left the battlefield. They do not heal back to full DC, so when summoned again they will have that same DC. Summoned units that are destroyed are not put back into the Daemon Pool. Note that this may lead to the formation breaking if the number of Blast markers on the formation is greater than the number of units left in play after the summoned units have been removed. When a formation breaks any summoned units in the formation are lost in the warp and considered destroyed. They do not go back into the Daemon Pool.</description>
    ...
    <rule id="141f-fed4-6d70-0fb5" name="Dreadclaws (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Module d&apos;Assaut Dreadclaw: Pour déployer la formation utilisant des Dreadclaws, Placez un « marqueur de Dreadclaw » en utilisant les règles d’Assaut Planétaire. Le Dreadclaw est un marqueur comptant comme la première unité de la formation au moment de déterminer son emplacement d’arrivée en Assaut Planétaire. Une fois le marqueur de Dreadclaw placé, Résolvez son attaque de tir de Deadclaw sur toutes les unités ennemies à moins de 15 cm du centre du Dreadclaw. Chaque formation ennemie attaquée reçoit un Pion Impact selon les règles normales de tir.  • Ensuite, débarquez les troupes transportées en Dreadclaw (cela peut déclencher un tir d’État d’Alerte normalement) complètement à moins de 15 cm du centre de celui-ci, en cohérence et en dehors de toute zone de contrôle ennemie.  • Le Dreadclaw n&apos;étant pas une unité mais un marqueur, il ne possède pas de zone de contrôle et il ne compte pas pour la cohérence de la formation. De plus, il ne peut pas être utilisé pour revendiquer un feu croisé ainsi que pour tenir ou contester des objectifs.  • Si plusieurs formations utilisent des Dreadclaws, placez tous les marqueurs Dreadclaw aux coordonnées prédéterminées en utilisant les règles d’Assaut Planétaire (y compris la résolution de dispersion). Une fois tous les marqueurs placés, résolvez toutes les attaques de Deathclaw simultanément contre les formations ennemies à portée des marqueurs Dreadclaw, puis débarquez toutes les formations transportées, en suivant les règles ci-dessus.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Garra de Muerte: Para desplegar una formación usando garras de muerte, coloca un &quot;marcador de garra de muerte&quot; usando las reglas de Caída Orbital. La garra de muerte es un marcador que cuenta como la primera unidad de la formación cuando se determina su zona de caída en la Caída Orbital. Una vez que se coloca el marcador de garra de muerte, su Deathwind dispara a todas las unidades enemigas a menos de 15 cm del centro de la garra de muerte. Cada formación enemiga que es atacada recibe un Marcador de Explosión según las reglas normales de disparo.  • Luego, se desembarca a las tropas transportadas en la Garra de la Muerte (esto puede provocar Fuego de Supresión como es habitual) completamente dentro de los 15 cm del centro de la misma, en coherencia y fuera de cualquier zona de control enemiga.  • La Garra de Muerte no es una unidad sino un marcador, no tiene zona de control y no cuenta para la coherencia de la formación. Además, no se puede utilizar para reclamar un tiroteo, ni para capturar o disputar objetivos.  • Si varias formaciones usan garras de muerte, coloca todos los marcadores de garras de muerte en coordenadas predeterminadas usando las reglas de Caída Orbital (incluyendo la resolución de la dispersión). Una vez que se hayan colocado todos los marcadores, resuelve todos los ataques de Viento Mortal simultáneamente contra las formaciones enemigas dentro del rango de los marcadores de Garra de Muerte, y luego desembarca todas las formaciones transportadas, siguiendo las reglas anteriores.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Taranteln: Um eine Formation unter Verwendung von Taranteln aufzustellen, platzieren Sie eine &quot;Tarantelmarkierung&quot; unter Verwendung der Planetfall-Regeln. Die Tarantel ist eine Markierung, die als erste Einheit der Formation zählt, wenn ihre Abwurfzone in Planetfall bestimmt wird. Sobald die Tarantel-Markierung platziert ist, feuert ihr Deathwind auf alle feindlichen Einheiten im Umkreis von 15 cm vom Zentrum der Tarantel. Jede feindliche Formation, die angegriffen wird, erhält einen Blast-Marker gemäß den normalen Schießregeln.  • Dann werden die in der Tarantel transportierten Truppen (dies kann wie üblich eine Überwachen auslösen) im Umkreis von 15 cm um das Zentrum der Tarantel, in Kohärenz und außerhalb jeder feindlichen Kontrollzone vollständig ausgeschifft.  • Die Tarantel ist keine Einheit, sondern eine Markierung, sie hat keine Kontrollzone und zählt nicht für die Kohärenz der Formation. Darüber hinaus kann sie nicht dazu verwendet werden, ein Kreuzfeuer zu beanspruchen oder Ziele einzunehmen oder zu bekämpfen.  • Wenn mehrere Formationen Taranteln verwenden, platzieren Sie alle Tarantelmarkierungen unter Verwendung der Planetfallregeln (einschließlich der Streuungsauflösung) an vorgegebenen Koordinaten. Sobald alle Markierungen gesetzt sind, lösen Sie alle Deathwind-Angriffe gleichzeitig gegen feindliche Formationen auf, die sich in Reichweite der Tarantelmarkierungen befinden, und verlassen Sie dann alle transportierten Formationen unter Beachtung der obigen Regeln.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>To deploy a formation using Dreadclaws, place a &quot;Dreadclaw marker&quot; using the Planetfall rules. The Dreadclaw is a marker counting as the first unit of the formation when determining its drop zone in Planetfall. Once the Dreadclaw marker is placed, its Deathwind fires on all enemy units within 15cm of the centre of the Dreadclaw. Each enemy formation that is attacked receives a Blast Marker according to the normal shooting rules.
Then, disembark the troops transported in Dreadclaw (this can trigger an Overwatch as usual) completely within 15 cm of the center of it, in coherency and outside any enemy zone of control.
The Dreadclaw is not a unit but a marker, it does not have a zone of control and it does not count for the coherency of the formation. In addition, it cannot be used to claim a crossfire, nor to capture or contest objectives.
If multiple formations use Dreadclaws, place all Dreadclaw markers at predetermined coordinates using the Planetfall rules (including scatter resolution). Once all the markers are set, resolve all Deathwind attacks simultaneously against enemy formations within range of the Dreadclaw markers, then disembark all transported formations, following the rules above.</description>
    </rule>
...
Bunkers can be a maximum of 6cm x 5cm in size. Trenches and Minefields can be up to 50cm x 2.5cm.</description>
    ...
    <rule id="3cbb-2959-7c15-17b9" name="Space Marine Transports (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Transports: Les Space Marines sont une armée très mobile. De ce fait, le coût en points d&apos;une formation comprend assez de Rhinos pour la transporter les formations comprennent la mention &quot;plus transports&quot; dans leur composition.  • Le nombre de Rhinos sera toujours égal au minimum nécessaire pour transporter la formation vous ne pouvez pas en prendre davantage.  • Toutefois, prendre des Rhinos pour la formation n’est pas obligatoire si vous ne le voulez pas. Si vous avez acheté des véhicules avec une capacité de transport pour la formation (comme des des Land Raiders), on considère qu’ils transportent au maximum de leurs capacités et que vous avez ensuite droit à assez de Rhinos pour transporter ce qu&apos;il reste de la formation (même si un Rhino ne se retrouve qu’à la moitié de sa capacité de transport).  • En outre, vous pouvez choisir de remplacer tous les Rhinos de la formation par un Dreadnought OU par des Modules d’atterrissage.  • Si vous choisissez les Modules d’atterrissage, la formation entrera en jeu en utilisant les règles d’Assaut Planétaire. Un Croiseur d’Attaque ou d’une Barge de Bataille sera nécessaire pour déployer les Modules d’atterrissage.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transporte: Space Marines sind eine sehr mobile Armee. Infolgedessen sind in den Punktekosten einer Formation genügend Rhinos enthalten, um ihn zu transportieren die Formation enthalten in ihrer Zusammensetzung den Vermerk &quot;plus Transport&quot;.  • Die Anzahl der Rhinos entspricht immer dem Minimum, das zum Tragen der Formation erforderlich ist. Sie können nicht mehr nehmen.  • Die Einnahme von Rhinos ist jedoch nicht zwingend. Wenn Sie Fahrzeuge mit einer Transportkapazität für die Formation (z. B. Land Raiders) erworben haben, wird davon ausgegangen, dass sie so viel tragen, wie sie können, und dann haben Sie genügend Rhinos, um das übrig gebliebene zu tragen (selbst wenn ein Rhino nur die Hälfte davon hat Transportkapazität).  • Außerdem können Sie alle Rhinos in der Formation durch einen Cybot ODER Landungskapseln ersetzen.  • Wenn Sie Landungskapseln wählen, wird die Formation mit den Planetfall-Regeln verwendet. Ein Angriffskreuzer oder Schlachtkreuzer wird benötigt, um die Landungskapseln einsetzen zu können.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transportes: Los Marines Espaciales son un ejército muy móvil. Debido a esto, el costo en puntos de una formación incluye suficientes Rhinos para transportarla, si las formaciones incluyen la nota &quot;más transporte&quot; en su composición.  • El número de Rhinos siempre será igual al mínimo necesario para transportar la formación; no puedes incluir más.  • Sin embargo, no es obligatorio adquirir los Rhinos. Si se han comprado vehículos con capacidad de transporte para la formación (como Land Raiders), se considera que transportan todo lo que pueden y entonces se tienen suficientes Rhinos para transportar lo que queda (incluso si un Rhino sólo está a la mitad de su capacidad de transporte).  • Además, puedes elegir reemplazar todos los Rhinos de la formación con un Dreadnought O Cápsulas de Desembarco.  • Si eliges Cápsulas de Desembarco, la formación entrará en juego usando las reglas de Desembarco Orbital. Se necesitará un Crucero de Asalto o una Barcaza de Batalla para desplegar las Cápsulas de Desembarco.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Space Marines are a highly mobile army. Therefore, the cost in points of a formation includes enough Rhinos to transport it, if the formations include the note &quot;plus transport&quot; in their composition.
The number of Rhinos will always be equal to the minimum necessary to carry the formation; you cannot take more.
