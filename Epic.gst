...
May only be used by formations made up exclusively of infantry, light vehicles, and armoured vehicle units that have the Walker ability; formations that include any other type of unit may not use a Wraithgate to enter play.</description>
    ...
    <rule id="b6e5-f14c-00dd-4f83" name="Drop Pod" hidden="false">
      <modifiers>
        ...
        <modifier type="set" field="description" value="Module d&apos;Atterrissage: Une formation se déployant par Assaut Planétaire et pouvant être transportée par Modules d’atterrissage le fait selon les règles spéciales suivantes : placez un marqueur de Module d’atterrissage en utilisant les règles d’Assaut Planétaire. Un Vaisseau en orbite sera nécessaire pour déployer les Modules d’atterrissage.  • Le Module d’atterrissage est un marqueur comptant comme la première unité de la formation au moment de déterminer son emplacement d’arrivée en Assaut Planétaire. Une fois le marqueur de Module d’atterrissage placé, résolvez son attaque de tir sur toutes les unités ennemies à moins de 15 cm du centre du Module d’atterrissage. Chaque formation ennemie attaquée reçoit un Pion Impact selon les règles normales de tir.  • Ensuite, faites débarquer les troupes transportées dans le Module d’atterrissage (cela peut déclencher un tir d’État d’Alerte normalement) complètement à moins de 15 cm du centre de celui-ci, en cohésion et en dehors de toute zone de contrôle ennemie. Si les unités ne peuvent débarquer en totalité en respectant les règles ci-dessus, les unités restantes seront détruites sans attribution de pions d&apos;impacts.  • Le Module d’atterrissage n&apos;étant pas une unité mais un marqueur, il ne possède pas de zone de contrôle et il ne compte pas pour la cohérence de la formation. De plus, il ne peut pas être utilisé pour revendiquer un feu croisé ainsi que pour tenir ou contester des objectifs.  • Si plusieurs formations utilisent des Modules d’atterrissage, placez tous les marqueurs Module d’atterrissage aux coordonnées prédéterminées en utilisant les règles d’Assaut Planétaire (y compris la résolution de dispersion). Une fois que tous les marqueurs sont placés, résolvez toutes les attaques des Modules d’atterrissage simultanément contre les formations ennemies à portée des marqueurs Module d’atterrissage. Les formations visées recevront un pion impact pour le tir pour chaque attaque du vaisseau ou des modules d&apos;atterrissage. Les pertes et les tirs ruptures infligent des PI normalement. Puis débarquez toutes les formations transportées, en suivant les règles ci-dessus.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
...
Gracias a warhammer40k.fandom.com/es</description>
    ...
    <rule id="c412-3011-0243-8d6a" name="Factions" hidden="false">
      <modifiers>
        ...
        <modifier type="set" field="description" value="Factions: Vous devez décider à quelle faction appartient chaque formation de votre armée avant la bataille et le noter sur votre liste d&apos;armée. A l&apos;exception des formations qui vénèrent le Chaos Universel, les différentes factions ne s&apos;entendent pas bien, et certaines factions se vouent une haine millénaire. Bien que les factions s&apos;unissent souvent sous l&apos;égide d&apos;un puissant Seigneur de Guerre pour combattre un ennemi commun, leur inimitié peut causer des problèmes lors d&apos;une bataille. Ceci est représenté par les règles suivantes :  • Les formations appartenant à Khorne détestent celles appartenant à Slaanesh, et vice-versa. Les formations appartenant à Tzeentch détestent celles appartenant à Nurgle, et vice-versa.  • Une formation qui n&apos;a aucune unité amie d&apos;une formation haïe à moins de 30 cm de l&apos;une de ses unités reçoit un modificateur de +1 à son test d&apos;Initiative. Si une seule unité amie de la formation haïe se trouve dans un rayon de 30 cm, ce bonus est perdu. Ce modificateur ne s&apos;applique qu&apos;aux unités présentes sur le champ de bataille ; les aéronefs, les vaisseaux spatiaux et toutes les autres formations qui ne sont pas en jeu ne reçoivent jamais ce modificateur.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
...
6: The creature is instantly killed.</description>
    ...
    <rule id="6791-edda-a014-7566" name="Rules for Daemons of All Types" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Règles des Démons de Tous Types: Sacrifiables : Les unités Sacrifiables ne génèrent pas de pion impact lorsqu&apos;elles sont détruites. Cependant, les unités Sacrifiables comptent dans le calcul des pertes lors de la résolution d&apos;un assaut.  • Instable : Si les démons sont démoralisés, ils sont détruits.  • Ils ne peuvent que contester les objectifs, pas les contrôler.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Regeln für Dämonen aller Art: Opferbereitschaft: Opfereinheiten erzeugen keinen Blast-Marker, wenn sie zerstört werden. Opfereinheiten zählen jedoch bei der Berechnung von Verlusten bei der Lösung eines Angriffs.  • Instabil: Wenn die Dämonen zerbrochen sind, werden sie zerstört.  • Darf Ziele nur herausfordern, nicht kontrollieren.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Reglas para los Demonios de Todos los Tipos: Sacrificable: Las unidades sacrificables no generan un marcador de explosión cuando son destruidas. Sin embargo, las unidades que se sacrifican cuentan en el cálculo de pérdidas cuando se resuelve un asalto.  • Inestable: Si los demonios están desmoralizados, son destruidos.  • Sólo pueden disputar objetivos, no controlarlos.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Sacrificial: Sacrificial units do not generate a blast marker when destroyed. However, Sacrificial units do count towards the casualty calculation when resolving an assault.
Unstable: If the daemons are broken, they are destroyed.
They may only contest objectives, not control them.</description>
    </rule>
    <rule id="d16f-1dde-8392-cee5" name="Summoned Units" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Unidades Invocadas: Las formaciones que compran la actualización del Pacto Demoníaco pueden invocar a los demonios en el campo de batalla. Para poder invocar demonios, los jugadores deben comprar primero una única Reserva de Demonios de la que todas las formaciones con la actualización del Pacto Demoníaco invocarán. Los demonios de la Reserva de Demonios se compran y se anotan sólo como demonios menores o mayores, no por su facción. La facción de la formación que invoca dicta qué tipos de demonios pueden ser invocados. Los jugadores deben anotar el contenido de su Reserva de Demonios o utilizar fichas para indicar el número de cada demonio mayor o menor que tienen disponible para invocar durante una partida. El oponente del jugador del Caos siempre puede ver el número de demonios menores y mayores que quedan en la Reserva de Demonios. La Reserva de Demonios se mantiene fuera del tablero y los demonios se eliminan de él a medida que las formaciones invocan a los demonios sobre el tablero.  • Al comienzo de la acción de esa formación, antes de que se haga la tirada de chequeo de acción, la formación puede invocar unidades demoníacas de la Reserva de Demonios. Invocar permite llamar a 2D3 puntos de invocación de unidades demoníacas en el campo de batalla (el número de puntos de invocación que cuesta invocar a una unidad estará listado en su hoja de datos, pero como regla general los demonios mayores cuestan 8 puntos de invocación y todas las demás unidades cuestan 1 punto de invocación cada una). Los puntos de invocación deben usarse para invocar unidades demoníacas de la Reserva de Demonios y las unidades invocadas se ponen en juego inmediatamente. Si por alguna razón los puntos de invocación generados no se usan, se pierden y no se pueden trasladar a los turnos siguientes. Sólo puedes invocar a tantos demonios como te queden en la Reserva de Demonios. Las unidades demoníacas sobrantes pueden ser invocadas durante un turno posterior. Las unidades demoníacas que son destruidas se retiran del juego y no se vuelven a poner en la Reserva de Demonios. Las formaciones desmoralizadas o que no hayan comprado un Pacto Demoníaco no pueden convocar a los demonios.  • Los jugadores sólo pueden tener un demonio mayor de una facción dada en el ejército en el tablero a la vez. Por ejemplo, si ya tienes un Devorador de Almas invocado sobre el tablero, no puedes invocar a otro Devorador de Almas hasta que ese primer demonio mayor haya sido retirado del juego. Las unidades invocadas deben colocarse con su peana a menos de 5 cm de cualquier unidad no demoníaca de su formación, (es decir, no se puede colocar una &quot;cadena&quot; de unidades invocadas). No pueden ponerse en la Zona de Control de una unidad enemiga o en terreno intransitable. El tipo de unidad que puede ser invocada depende de la facción de la formación que la invoca.  • Las unidades invocadas cuentan como parte de la formación para todos los propósitos de las reglas mientras permanezcan en el campo de batalla. La única excepción a las reglas normales es que cuando una unidad invocada es destruida, no causa que se coloque un marcador de explosión en la formación. Por lo demás, se cuentan como unidades normales, y se incluyen cuando se calcula si una formación supera en número a un oponente en un asalto o se rompe por los Marcadores de Explosión, etc. Nota que los demonios que mueren en un asalto cuentan para el número de unidades muertas por el enemigo cuando se calculan los modificadores a la tirada de dados del resultado. Si una formación pierde un asalto, se eliminan los impactos adicionales de la formación antes de que se considere rota y se eliminen todas las demás unidades invocadas.  • Las unidades invocadas permanecen en el campo de batalla hasta la fase de finalización del turno en el que son invocadas. Al final de la fase de reagrupación, después de que las formaciones hayan intentado reagruparse, todas las unidades convocadas en la formación se retiran del tablero y se colocan de nuevo en la Reserva de Demonios a menos que la formación tenga una unidad con Foco Demoníaco. Los Demonios mayores que son devueltos a la Reserva de Demonios mantienen el mismo FD que tenían cuando dejaron el campo de batalla. No se curan de nuevo a la totalidad del FD, así que cuando sean convocados de nuevo tendrán ese mismo FD. Las unidades invocadas que son destruidas no se devuelven a la Reserva de Demonios. Nótese que esto puede llevar a que la formación se desmoralice si el número de Marcadores de Explosión en la formación es mayor que el número de unidades que quedan en juego después de que las unidades invocadas hayan sido retiradas. Cuando una formación se desmoraliza, las unidades invocadas en la formación se pierden en la disformidad y se consideran destruidas. No vuelven a la Reserva de Demonios.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Einheiten Beschworen: Formationen, die das Upgrade des Dämonischen Pakts erwerben, können Dämonen auf das Schlachtfeld beschwören. Um Dämonen zu beschwören, muss ein Spieler zunächst einen einzigen Dämonenpool kaufen, aus dem alle Formationen mit der Aufwertung des Dämonischen Pakts beschwören können. Dämonen im Dämonenpool werden nur als Niedere Dämonen oder Größere Dämonen gekauft und vermerkt, nicht von ihrer Fraktion. Die Fraktion der beschwörenden Formation bestimmt, welche Arten von Dämonen beschworen werden dürfen. Die Spieler sollten entweder den Inhalt ihres Dämonenpools aufschreiben oder mit Hilfe von Spielsteinen die Anzahl der Niederen und Großen Dämonen angeben, die sie während eines Spiels beschwören können. Der Gegner des Chaosspielers hat immer die Möglichkeit, die Anzahl der im Dämonenpool verbleibenden kleineren und größeren Dämonen einzusehen. Der Dämonenpool wird vom Spielbrett ferngehalten, und Dämonen werden aus ihm entfernt, wenn Formationen Dämonen auf das Spielbrett beschwören.  • Zu Beginn der Aktion dieser Formation, bevor der Aktionstest-Würfelwurf ausgeführt wird, kann die Formation dämonische Einheiten aus dem Dämonenpool beschwören. Beschwörung ermöglicht es Ihnen, dämonische Einheiten im Wert von 2W3 Beschwörungspunkten auf das Schlachtfeld zu rufen (die Anzahl der Beschwörungspunkte, die es kostet, eine Einheit zu beschwören, wird auf ihrem Datenblatt aufgeführt, aber in der Regel kosten größere Dämonen 8 Beschwörungspunkte und alle anderen Einheiten jeweils 1 Beschwörungspunkt). Beschwörungspunkte müssen verwendet werden, um dämonische Einheiten aus dem Dämonenpool zu beschwören, und beschworene Einheiten werden sofort ins Spiel gebracht. Wenn aus irgendeinem Grund generierte Beschwörungspunkte nicht verwendet werden, sind sie verloren und dürfen nicht in nachfolgende Runden übertragen werden. Sie dürfen nur so viele Dämonen beschwören, wie Sie noch in Ihrem Dämonenpool haben. Verbleibende dämonische Einheiten können in einer späteren Runde beschworen werden. Dämonische Einheiten, die zerstört werden, werden aus dem Spiel entfernt und nicht wieder in den Dämonenpool zurückgelegt. Gebrochene Formationen oder Formationen, die keinen dämonischen Pakt gekauft haben, dürfen keine Dämonen beschwören.  • Die Spieler dürfen immer nur einen größeren Dämon einer bestimmten Fraktion in der Armee auf dem Brett haben. Wenn Sie zum Beispiel bereits einen beschworenen Blutdämon auf dem Brett haben, dürfen Sie keinen weiteren Blutdämon beschwören, bis der erste größere Dämon aus dem Spiel entfernt wurde. Beschworene Einheiten müssen so aufgestellt werden, dass ihre Basis nicht weiter als 5 cm von einer nicht-dämonischen Einheit entfernt ist (d.h. Sie können keine &quot;Kette&quot; beschworener Einheiten aufstellen). Sie dürfen nicht in der Kontrollzone einer gegnerischen Einheit oder in unpassierbarem Gelände aufgestellt werden. Die Art der Einheit, die beschworen werden kann, hängt von der Fraktion der beschwörenden Formation ab.  • Beschworene Einheiten zählen für alle Regelzwecke als Teil der Formation, solange sie auf dem Schlachtfeld bleiben. Die einzige Ausnahme von den normalen Regeln besteht darin, dass bei der Zerstörung einer beschworenen Einheit kein Blast-Marker auf die Formation gesetzt wird. Sie werden ansonsten als normale Einheiten gezählt und bei der Berechnung berücksichtigt, wenn eine Formation einen Gegner bei einem Angriff in der Überzahl hat oder durch Blast-Marker usw. durchbrochen wird. Beachten Sie, dass Dämonen, die bei einem Angriff getötet werden, bei der Berechnung der Modifikatoren für den Würfelwurf des Ergebnisses auf die Anzahl der vom Feind getöteten Einheiten angerechnet werden. Wenn eine Formation einen Angriff verliert, entfernen Sie zusätzliche Treffer aus der Formation, bevor sie als durchbrochen gilt und alle verbleibenden beschworenen Einheiten entfernt werden.  • Beschworene Einheiten bleiben bis zur Endphase der Runde, in der sie beschworen werden, auf dem Schlachtfeld. Am Ende der Sammelphase, nachdem die Formationen versucht haben, sich zu sammeln, werden alle beschworenen Einheiten in der Formation vom Spielbrett entfernt und wieder in den Dämonenpool gelegt, es sei denn, die Formation hat eine Einheit mit dämonischem Fokus. Größere Dämonen, die in den Dämonenpool zurückgebracht werden, behalten die gleiche DC, die sie hatten, als sie das Schlachtfeld verließen. Sie heilen nicht wieder zu einem vollen DC zurück, so dass sie bei einer erneuten Einberufung denselben DC haben. Beschworene Einheiten, die zerstört werden, werden nicht wieder in den Dämonenpool aufgenommen. Es ist zu beachten, dass dies zum Aufbrechen der Formation führen kann, wenn die Anzahl der Blast-Marker in der Formation größer ist als die Anzahl der Einheiten, die im Spiel bleiben, nachdem die beschworenen Einheiten entfernt wurden. Wenn eine Formation bricht, gehen alle beschworenen Einheiten in der Formation in der Verwerfung verloren und gelten als zerstört. Sie kehren nicht in den Dämonenpool zurück.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Unités Convoquées: Les formations qui achètent l&apos;amélioration Pacte Démoniaque sont capables d&apos;invoquer des démons sur le champ de bataille. Pour pouvoir invoquer des démons, les joueurs doivent d&apos;abord acheter une seule Réserve de Démons dans lequel toutes les formations ayant l&apos;amélioration Pacte Démoniaque pourront faire des invocations. Les démons de la Réserve de Démons sont achetés et notés uniquement comme étant des Démons Mineurs ou des Démons Majeurs, et non par leur faction. La faction de la formation qui fait l&apos;invocation dicte les types de démons qui peuvent être invoqués. Les joueurs doivent soit écrire le contenu de leur Réserve de Démons, soit utiliser des jetons pour indiquer le nombre de chaque Démon Mineur et Démon Majeur qu&apos;ils peuvent invoquer au cours d&apos;une partie. L&apos;adversaire du joueur du Chaos peut toujours voir le nombre de démons de plus ou moins grande taille restant dans la Réserve de Démons. La Réserve de Démons est maintenu hors du plateau de jeu et les démons en sont retirés au fur et à mesure que les formations invoquent des démons sur le plateau de jeu.  • Au début de l&apos;action de cette formation, avant que le test d&apos;action ne soit effectué, la formation peut invoquer des unités démoniaques de la Réserve de Démons. L&apos;invocation vous permet d&apos;invoquer 2d3 points d&apos;invocation d&apos;unités démoniaques sur le champ de bataille (le nombre de points d&apos;invocation nécessaires pour invoquer une unité sera indiqué sur sa fiche technique, mais en règle générale, les Démons Majeurs coûtent 8 points d&apos;invocation et toutes les autres unités coûtent 1 point d&apos;invocation chacune). Les points d&apos;invocation doivent être utilisés pour invoquer des unités démoniaques de la Réserve de Démons et les unités invoquées sont mises en jeu immédiatement. Si, pour une raison quelconque, les points d&apos;invocation générés ne sont pas utilisés, ils sont perdus et ne peuvent être reportés aux tours suivants. Vous ne pouvez invoquer qu&apos;autant de démons qu&apos;il vous reste dans votre Réserve de Démons. Les unités de démons restantes peuvent être invoquées lors d&apos;un tour ultérieur. Les unités démoniaques qui sont détruites sont retirées du jeu et ne sont pas remises dans la Réserve de Démons. Les formations démoralisées ou les formations qui n&apos;ont pas acheté un pacte démoniaque ne peuvent pas invoquer de démons.  • Les joueurs ne peuvent avoir qu&apos;un seul Démon Majeur d&apos;une faction donnée de l&apos;armée sur le plateau de jeu à la fois. Par exemple, si vous avez déjà invoqué un Buveur de Sang sur le plateau de jeu, vous ne pouvez pas en invoquer un autre avant que le premier démon plus grand n&apos;ait été retiré du jeu. Les unités invoquées doivent être installées avec leur base à moins de 5 cm de toute unité non démoniaque de leur formation (c&apos;est-à-dire que vous ne pouvez pas placer une &quot;chaîne&quot; d&apos;unités invoquées). Elles ne peuvent pas être installées dans la zone de contrôle d&apos;une unité ennemie ou sur un terrain infranchissable. Le type d&apos;unité qui peut être invoquée dépend de la faction de la formation qui l&apos;invoque.  • Les unités invoquées comptent comme faisant partie de la formation pour toutes les règles tant qu&apos;elles restent sur le champ de bataille. La seule exception aux règles normales est que lorsqu&apos;une unité invoquée est détruite, elle n&apos;entraîne pas le placement d&apos;un pion d&apos;impact sur la formation. Elles sont autrement comptées comme des unités normales et sont incluses lors de l&apos;entraînement si une formation est plus nombreuse qu&apos;un adversaire lors d&apos;un assaut si elle est démoralisée par un pion d&apos;impact, etc. Notez que les Daemons tués lors d&apos;un assaut comptent dans le nombre d&apos;unités tuées par l&apos;ennemi lors de l&apos;élaboration des modificateurs au jet de dés de résultat. Si une formation perd un assaut, vous retirez les tués supplémentaires de la formation avant qu&apos;elle ne soit considérée comme démoralisée et que toutes les unités restantes invoquées soient retirées.  • Les unités invoquées restent sur le champ de bataille jusqu&apos;à la phase finale du tour où elles sont invoquées. A la fin de la phase de ralliement, après que les formations aient tenté de se rallier, toutes les unités invoquées de la formation sont retirées du plateau et replacées dans la Réserve de Démons, sauf si la formation possède une unité à Focalisation Démoniaque. Les Démons Majeurs qui sont replacés dans la Réserve de Démons conservent le même CD qu&apos;ils avaient lorsqu&apos;ils ont quitté le champ de bataille. Ils ne guérissent pas pour revenir à un CD complet, donc lorsqu&apos;ils sont à nouveau convoqués, ils ont le même CD. Les unités invoquées qui sont détruites ne sont pas replacées dans la Réserve de Démons. Notez que cela peut entraîner la démoralisation de la formation si le nombre de Pions d&apos;Impact sur la formation est supérieur au nombre d&apos;unités en jeu après que les unités invoquées aient été retirées. Lorsqu&apos;une formation est démoralisée, toutes les unités invoquées de la formation sont perdues dans le warp et sont considérées comme détruites. Elles ne retournent pas dans la Réserve de Démons.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Formations that purchase the Daemonic Pact upgrade are able to summon daemons to the battlefield. In order to summon daemons a players must first purchase a single Daemon Pool from which all formations with the Daemonic Pact upgrade will summon. Daemons in the Daemon Pool are purchased and noted only as being lesser or greater daemons, not by their faction. The summoning formation’s faction dictates what types of daemons may be summoned. Players should either write down the contents of their Daemon Pool or use tokens to indicate the number of each lesser and greater daemon they have available to summon during a game. The Chaos player’s opponent is always able to view the number of lesser and greater daemons remaining in the Daemon Pool. The Daemon Pool is kept off the board and daemons are removed from it as formations summon daemons onto the board.
...
Players may only have one greater daemon of a given faction in the army on the board at one time. For example, if you already have a summoned Bloodthirster on the board you are not allowed to summon another Bloodthirster until that first greater daemon has been removed from play. Summoned units must be set up with their base within 5cm of any non-daemonic unit from their formation, (i.e. you cannot place a ‘chain’ of summoned units). They may not be set up in the Zone of Control of an enemy unit or in impassable terrain. The type of unit that can be summoned depends on the summoning formation’s faction.
Summoned units count as part of the formation for all rules purposes as long as they remain on the battlefield. The only exception to the normal rules is when a summoned unit is destroyed it does not cause a blast marker to be placed on the formation. They are otherwise counted as normal units, and are included when working out if a formation outnumbers an opponent in an assault or is broken by blast markers, etc. Note that Daemons that are killed in an assault do count towards the number of units killed by the enemy when working out modifiers to the result dice roll. If a formation loses an assault you remove extra hits from the formation before it is considered broken and all the remaining summoned units are removed.
Summoned units remain on the battlefield until the end phase of the turn in which they are summoned. In the end of the rally phase, after formations have attempted to rally, all summoned units in the formation are removed from the board and placed back into the Daemon Pool unless the formation has a unit with Daemonic Focus. Greater Daemons that are returned to the Daemon Pool keep the same DC they had when they left the battlefield. They do not heal back to full DC, so when summoned again they will have that same DC. Summoned units that are destroyed are not put back into the Daemon Pool. Note that this may lead to the formation breaking if the number of Blast Markers on the formation is greater than the number of units left in play after the summoned units have been removed. When a formation breaks any summoned units in the formation are lost in the warp and considered destroyed. They do not go back into the Daemon Pool.</description>
    </rule>
    <rule id="273c-2b82-077c-51a1" name="Summoned Units (EpicUK)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Unidades Invocadas: Las formaciones que compran la actualización del Pacto Demoníaco, o las unidades con esta habilidad, permiten al jugador del Caos invocar demonios al campo de batalla. Para invocar demonios el jugador también debe tener una reserva demoníaca desde la que invocar. Esta reserva contiene dos secciones, una para demonios menores y otra para grandes demonios y no es específica de una facción. El tamaño de dichas reservas debe ser visible para todos los jugadores en todo momento y se sugiere que se utilicen fichas o dados para indicar el tamaño de cada reserva disponible. A medida que los demonios son convocados, la reserva debe ser cambiada para reflejar su tamaño actual.  • Para invocar a los demonios, el jugador del Caos elige una formación con un pacto demoníaco y declara su intención de invocar antes de que se realice cualquier tirada de acción. El jugador tira entonces 2D3 para generar el número de puntos de invocación disponibles para esta formación. El número de puntos necesarios para invocar cada tipo de unidad demoníaca se anotará en su hoja de datos. La formación puede entonces invocar demonios hasta el número de puntos de invocación generados, hasta el número de puntos que queden en la reserva demoníaca. Los puntos que no se utilicen se perderán. La facción (debe ser anotada en la creación de la lista) de la formación que invoca determina qué tipo de demonios pueden ser invocados.  • Nótese que el Caos Absoluto puede invocar Bestias Demoníacas / cualquier Gran Demonio como es normal, o cualquier otro Demonio Menor por el doble de los puntos de invocación habituales.  • Los jugadores sólo pueden tener un gran demonio para una facción dada en la mesa a la vez. Las unidades invocadas deben colocarse a menos de 5 cm de una unidad no invocada en la formación que invoca. No pueden colocarse en zonas de control o terreno intransitable del enemigo.  • Las unidades invocadas pasan a formar parte de la formación que las invoca para todos los propósitos de las reglas, mientras permanezcan en el campo de batalla. Las unidades invocadas no causan marcadores de explosión cuando son destruidas, sin embargo las unidades demoníacas muertas en un asalto cuentan para el número de unidades muertas cuando se calculan los modificadores para la resolución del asalto. Las unidades invocadas que son destruidas son retiradas del juego y el coste de la invocación de cada unidad se pierde de la reserva demoníaca del jugador.  • Las unidades invocadas permanecen en el juego hasta la fase de finalización del turno en el que fueron invocadas. Después de que todas las formaciones hayan intentado reorganizar las unidades invocadas, se retiran del juego y se devuelven a la reserva demoníaca. Esto puede causar que la formación se desmoralice ya que ahora puede tener igual o más marcadores de explosión que su número de unidades. Los Grandes Demonios devueltos a la reserva de Grandes Demonios mantienen los puntos de daño tomados y no curan estos puntos mientras están fuera del tablero. Cuando son convocados posteriormente, mantienen este daño.  • Cuando una formación se desmoraliza, todas sus unidades invocadas son destruidas. Al calcular los puntos de victoria, la reserva de Demonios Menores obtiene la mitad de los puntos si el fondo tiene menos o igual a la mitad (redondeando hacia arriba) de su número original de demonios restantes. La reserva del Demonio Menor obtiene puntos completos si a la reserva le queda menos o igual a un cuarto (redondea hacia arriba) de sus demonios. Trata a los Grandes Demonios como máquinas de guerra con el propósito de calcular los puntos de victoria.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Einheiten Beschworen: Formationen, die die Aufwertung des Dämonischen Pakts oder Einheiten mit dieser Fähigkeit erwerben, ermöglichen es dem Chaos-Spieler, Dämonen auf das Schlachtfeld zu beschwören. Um Dämonen zu beschwören, muss der Spieler außerdem über einen Dämonenpool verfügen, aus dem er Dämonen beschwören kann. Dieser Pool enthält zwei Sektionen, eine für niedere Dämonen und eine für größere Dämonen, und ist nicht fraktionsspezifisch. Die Größe solcher Pools muss für alle Spieler jederzeit sichtbar sein, und es wird vorgeschlagen, dass entweder Spielsteine oder Würfel verwendet werden, um die Größe jedes verfügbaren Pools anzuzeigen. Wenn Dämonen beschworen werden, muss der Pool geändert werden, damit er seine aktuelle Größe widerspiegelt.  • Um Dämonen zu beschwören, wählt der Chaos-Spieler eine Formation mit einem dämonischen Pakt und erklärt seine Absicht zu beschwören, bevor ein Aktionswurf ausgeführt wird. Der Spieler würfelt dann 2W3, um die Anzahl der für diese Formation verfügbaren Beschwörungspunkte zu generieren. Die Anzahl der Punkte, die erforderlich sind, um jede Art von dämonischer Einheit zu beschwören, wird auf seinem Datenblatt vermerkt. Die Formation kann dann Dämonen bis zur Anzahl der generierten Beschwörungspunkte beschwören, bis zur Anzahl der im Dämonenpool verbleibenden Punkte. Alle nicht verwendeten Punkte gehen verloren.  • Die Fraktion (muss bei der Listenerstellung vermerkt werden) der Beschwörungsformation bestimmt, welche Art von Dämonen beschworen werden darf.  • Hinweis Ungeteilt kann dämonische Bestien / jeden Größeren Dämonen wie üblich beschwören oder jeden anderen Kleinen Dämonen für das Doppelte der üblichen Beschwörungspunkte beschwören.  • Die Spieler dürfen jeweils nur einen größeren Dämon für eine bestimmte Fraktion auf dem Tisch haben. Beschworene Einheiten müssen innerhalb von 5 cm von einer nicht beschworenen Einheit in der Beschwörungsformation aufgestellt werden. Sie dürfen nicht in feindliche Kontrollzonen oder unpassierbares Gelände platziert werden.  • Beschworene Einheiten werden für alle Regelzwecke Teil der Beschwörungsformation, solange sie auf dem Schlachtfeld bleiben. Beschworene Einheiten verursachen keine Blast-Marker, wenn sie zerstört werden. Dämonische Einheiten, die bei einem Angriff getötet werden, werden jedoch bei der Berechnung der Modifikatoren für die Angriffsauflösung auf die Anzahl der getöteten Einheiten angerechnet. Beschworene Einheiten, die zerstört werden, werden aus dem Spiel entfernt, und die Beschwörungskosten jeder Einheit gehen aus dem Dämonenpool des Spielers verloren.Beschworene Einheiten bleiben bis zur Endphase der Runde, in der sie beschworen wurden, im Spiel. Nachdem alle Formationen versucht haben, sich zu sammeln, werden alle beschworenen Einheiten aus dem Spiel entfernt und in den Dämonenpool zurückgelegt. Dies kann dazu führen, dass die Formation zerbricht, da sie nun möglicherweise gleich viele oder mehr Blast-Marker hat als Einheiten vorhanden sind. Greater Daemons, die in den Greater Daemon Pool zurückkehren, behalten alle Schadenspunkte und heilen diese Punkte nicht, solange sie nicht an Bord sind. Wenn sie später beschworen werden, behalten sie diesen Schaden bei.  • Wenn eine Formation zerbricht, werden alle ihre beschworenen Einheiten zerstört. Bei der Berechnung der Siegpunkte erhält der Pool der Niederen Dämonen die Hälfte der Punkte, wenn der Pool weniger als die Hälfte (aufgerundet) der ursprünglichen Anzahl der verbleibenden Dämonen aufweist. Der Pool der Niederen Dämonen erhält volle Punkte, wenn der Pool weniger als oder gleich einem Viertel (aufgerundet) seiner verbliebenen Dämonen hat. Größere Dämonen werden bei der Berechnung der Siegpunkte als Kriegsmaschinen behandelt.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Unités Convoquées: Les formations qui achètent l&apos;amélioration Pacte Démoniaque, ou les unités ayant cette capacité, permettent au joueur du Chaos d&apos;invoquer des démons sur le champ de bataille. Pour invoquer des démons, le joueur doit également disposer d&apos;une réserve de démons à partir duquel il peut les invoquer. Ce réserve contient deux sections, une pour les Démons Mineurs et une pour les Démons Majeurs, et n&apos;est pas spécifique à une faction. La taille de ces réserves doit être visible par tous les joueurs à tout moment et il est suggéré d&apos;utiliser des jetons ou des dés pour indiquer la taille de chaque réserve disponible. Lorsque des démons sont invoqués, la réserve doit être modifié pour refléter sa taille actuelle.  • Pour invoquer des démons, le joueur du Chaos choisit une formation avec un pacte démoniaque et déclare son intention d&apos;invoquer avant tout jet d&apos;action. Le joueur lance alors 2d3 pour générer le nombre de points d&apos;invocation disponibles pour cette formation. Le nombre de points requis pour invoquer chaque type d&apos;unité démoniaque sera noté sur sa fiche de données. La formation peut alors invoquer des démons jusqu&apos;à concurrence du nombre de points d&apos;invocation générés, jusqu&apos;à concurrence du nombre de points restants dans la réserve de démons. Les points non utilisés sont perdus.  • La faction (qui doit être notée lors de la création de la liste) de la formation d&apos;invocation détermine le type de démons qui peuvent être invoqués.  • Note : Undivided peut invoquer des Bêtes Démoniaques / tout Démon Majeur comme d&apos;habitude, ou tout autre Démon Mineur pour le double des points d&apos;invocation habituels.  • Les joueurs ne peuvent avoir qu&apos;un seul Démon Majeur pour une faction donnée sur la table à la fois. Les unités invoquées doivent être placées à moins de 5 cm d&apos;une unité non invoquée dans la formation qui les invoque. Elles ne peuvent pas être placées dans des zones de contrôle ennemies ou en terrain impraticable.  • Les unités invoquées font partie de la formation d&apos;invocation pour toutes les règles tant qu&apos;elles restent sur le champ de bataille. Les unités invoquées ne provoquent pas de pion d&apos;impact lorsqu&apos;elles sont détruites, mais les unités démoniaques tuées au cours d&apos;un assaut comptent dans le nombre d&apos;unités tuées lors du calcul des modificateurs de résolution d&apos;assaut. Les unités invoquées qui sont détruites sont retirées du jeu et le coût d&apos;invocation de chaque unité est perdu dans la réserve de démons du joueur.  • Les unités invoquées restent en jeu jusqu&apos;à la fin de la phase du tour où elles ont été invoquées. Après que toutes les formations aient tenté de se rallier, les unités invoquées sont retirées du jeu et replacées dans la réserve de démons. Cela peut entraîner la démoralisation de la formation, car elle peut maintenant avoir un nombre de pions d&apos;impact égal ou supérieur à son nombre d&apos;unités. Les Démons Majeurs retournés dans la réserve de Démons Majeurs conservent les points de dégâts qu&apos;ils ont subis et ne les soignent pas lorsqu&apos;ils sont hors jeu. Lorsqu&apos;ils sont invoqués par la suite, ils conservent ces dommages.  • Lorsqu&apos;une formation est démoralisée, toutes les unités qu&apos;elle a invoquées sont détruites. Lors du calcul des points de victoire, la réserve de Démons Mineurs marque un demi-point si le pool a moins ou égal à la moitié (arrondie à l&apos;entier supérieur) de son nombre initial de Démons restants. La réserve du Démons Mineurs rapporte des points complets si le nombre de démons restant est inférieur ou égal au quart (arrondi à l&apos;entier supérieur) de son nombre initial. Les Démons Majeurs sont considérés comme des engins de guerre pour le calcul des points de victoire.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Formations that purchase the Daemonic Pact upgrade, or units with this ability, allow the Chaos player to summon daemons to the battlefield. To summon Daemons the player must also have a Daemonic pool from which to summon. This pool contains two sections, one for lesser daemons and one for greater daemons and is not faction specific. The size of such pools must be visible to all players at all times and it is suggested that either tokens or dice are used to indicate the size of each pool available. As daemons are summoned the pool must be changed to reflect its current size.
To summon daemons the Chaos player chooses a formation with a daemonic pact and declares its intention to summon before any action roll is made. The player then rolls 2D3 to generate the number of summoning points available for this formation. The number of points required to summon each type of daemonic unit will be noted on its data sheet. The formation may then summon daemons up to the number of summoning points generated, up to the number of points left in the daemonic pool. Any points not used are lost.
The faction (must be noted at list creation) of the summoning formation determines what type of daemons may be summoned.
Note Undivided may summon Daemonic Beasts / any Greater Daemon as normal, or any other Lesser Daemon for twice the usual summoning points.
Players may only have one greater daemon for a given faction on the table at a time. Summoned units must be set up within 5cm of a non-summoned unit in the summoning formation. They cannot be placed in enemy zones of control or impassable terrain.
Summoned units become part of the summoning formation for all rules purposes as long as they remain on the battlefield. Summoned units do not cause blast markers when they are destroyed however daemonic units killed in an assault count towards the number of units killed when calculating the modifiers for assault resolution. Summoned units that are destroyed are removed from play and the summoning cost of each unit is lost from the player’s daemonic pool.
Summoned units remain in play until the end phase of the turn in which they were summoned. After all formations have attempted to rally any summoned units are removed from play and returned to the daemonic pool. This may cause the formation to break as it may now have equal or more blast markers than its number of units. Greater Daemons returned to the Greater daemon pool keep any damage points taken and do not heal these points while off board. When summoned subsequently they maintain this damage.
When a formation breaks all of its summoned units are destroyed. When calculating victory points, the Lesser Daemon pool scores half points if the pool has less than or equal to half (round up) its original number of daemons remaining. The Lesser Daemon pool scores full points if the pool has less than or equal to a quarter (round up) its daemons remaining. Treat Greater Daemons as war engines for the purpose of calculating victory points.</description>
    </rule>
    <rule id="abd8-392c-802c-4956" name="Summoned Units (NetEA)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Unidades Invocadas: Cada formación de un ejército del Caos pertenece a una facción leal a uno de los Dioses del Caos, o al Caos Absoluto. Debes decidir a qué facción pertenece cada formación de tu ejército antes de la batalla y anotarlo en tu lista de ejército. Las formaciones que adquieran la mejora Pacto Demoníaco serán capaces de invocar Demonios al campo de batalla.  • Al adquirir los Demonios de la reserva demoníaca, sólo debes indicar cuántos Demonios Menores y Grandes Demonios deseas, no hay que especificar a qué facción pertenecen exactamente. La facción de la formación que los invoque será la que determine la facción de los Demonios invocados. Los jugadores deberían llevar el control de los Demonios Menores y Grandes Demonios que quedan en la reserva, mediante contadores o anotándolo en papel. El contenido de la reserva demoníaca no es secreto. La reserva demoníaca se mantendrá fuera del tablero, junto a las reservas, y se irá vaciando a medida que las formaciones invoquen Demonios.  • Al comienzo de la acción de la formación, antes de tirar el dado del chequeo de acción, la formación podrá invocar unidades demoníacas de la reserva. Invocar te permitirá generar 2D3 puntos de invocación y colocar las unidades en el campo de batalla (el número de puntos que cuesta cada unidad demoníaca se muestra en la lista de más abajo entre paréntesis). Las unidades invocadas se colocan inmediatamente. Los puntos que no se hayan gastado por cualquier razón se perderán (no pueden guardarse para otros turnos). Sólo será posible invocar a los Demonios que haya disponibles en la reserva demoníaca. Las unidades que queden en la reserva demoníaca podrán ser invocadas en subsiguientes turnos. Los Demonios que sean destruidos se retiran del juego y no vuelven a la reserva demoníaca. Las formaciones desmoralizadas, y aquellas que no hayan adquirido el Pacto Demoníaco, no podrán invocar Demonios.  • Sólo puede haber un Gran Demonio de cada facción a la vez en el campo de batalla. Por ejemplo: si ya has invocado a un Devorador de Almas, no podrás invocar a otro Devorador de Almas hasta que el primero haya sido eliminado del juego. Las unidades demoníacas invocadas deberán situarse a 5 cm o menos de una unidad “no demoníaca” de la formación (es decir, no puedes formar una cadena de unidades invocadas), fuera de la zona de control de cualquier unidad enemiga, y fuera de terreno intransitable.  • Las unidades invocadas cuentan como parte de la formación para cualquier propósito mientras sigan en juego. Las unidades invocadas son prescindibles, pero siguen contando para la superioridad numérica durante un asalto, para ver si la formación se desmoraliza por tener marcadores de explosión, etc. Nótese que los Demonios aniquilados durante un asalto cuentan a la hora de contabilizar las bajas producidas por cada bando. Si la formación es derrotada en un asalto, asigna primero cualquier impacto adicional, y luego retira a todas las unidades invocadas que queden.  • Las unidades invocadas permanecerán en el campo de batalla hasta la Fase de Finalización del turno en el que hayan sido invocadas. Después de que todas las formaciones hayan intentado reorganizarse, todas las unidades invocadas se retiran de la mesa y vuelven a la reserva demoníaca, a no ser que la formación que las invocó tenga una unidad con Foco Demoníaco. Los Grandes Demonios que regresen a la reserva demoníaca mantendrán el mismo factor de daños que tenían al abandonar el campo de batalla, no se “curan”, de forma que conservarán el daño que hayan recibido si son invocados de nuevo. Las unidades destruidas no regresan a la reserva demoníaca. Nótese que el hecho de retirar unidades de esta forma puede provocar que algunas formaciones con marcadores de explosión queden desmoralizadas. Si una formación es desmoralizada, cualquier unidad invocada que forme parte de ella se perderá en la disformidad, de forma que se retirará del juego y no regresará a la reserva demoníaca.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Einheiten Beschworen: Formationen, die das Upgrade des Dämonenpakts erwerben, können Dämonen auf das Schlachtfeld rufen.  • Dämonen im Dämonenpool werden gekauft und nur als niedere oder größere Dämonen bezeichnet, nicht als Fraktion. Die Fraktion der Beschwörungsformation bestimmt, welche Arten von Dämonen beschworen werden dürfen. Die Spieler sollten entweder den Inhalt ihres Dämonenpools aufschreiben oder Token verwenden, um die Anzahl jedes kleineren und größeren Dämonen anzugeben, den sie während eines Spiels zur Verfügung stellen können. Der Gegner des Chaosspielers kann immer die Anzahl der im Dämonenpool verbleibenden niederen und größeren Dämonen sehen. Der Dämonenpool wird vom Brett ferngehalten und Dämonen werden aus dem Pool entfernt, wenn Formationen Dämonen auf das Brett rufen.  • Zu Beginn der Aktion dieser Formation, bevor der Würfelwurf des Aktionstests ausgeführt wird, kann die Formation dämonische Einheiten aus dem Dämonenpool heraufbeschwören. Beschwörung ermöglicht das Aufrufen von 2D3-Beschwörungspunkten von dämonischen Einheiten auf dem Schlachtfeld (die Anzahl der Beschwörungspunkte, die die Beschwörung einer Einheit kostet, ist in Klammern nach jeder Einheit angegeben). Beschwörungspunkte müssen verwendet werden, um dämonische Einheiten aus dem Dämonenpool zu beschwören, und beschworene Einheiten werden sofort ins Spiel gebracht. Wenn aus irgendeinem Grund erzeugte Beschwörungspunkte nicht verwendet werden, gehen sie verloren und können nicht in nachfolgende Züge übertragen werden. Du kannst nur so viele Dämonen beschwören, wie du in deinem Dämonenpool zurückgelassen hast. Übriggebliebene dämonische Einheiten können in einer späteren Runde beschworen werden. Zerstörte Dämoneneinheiten werden aus dem Spiel genommen und nicht in den Dämonenpool zurückgelegt. Gebrochene Formationen oder Formationen, die keinen Dämonischen Pakt gekauft haben, dürfen keine Dämonen beschwören.  • Spieler dürfen nur einen einzigen größeren Dämon einer bestimmten Fraktion in der Armee gleichzeitig am Brett haben. Wenn Sie beispielsweise bereits einen gerufenen Blutdämon auf der Tafel haben, dürfen Sie keinen weiteren Blutdämon herbeirufen, bis der erste größere Dämon aus dem Spiel entfernt wurde. Beschworene Einheiten müssen so aufgestellt werden, dass ihre Basis weniger als 5 cm von jeder nicht dämonischen Einheit von ihrer Formation entfernt ist (d. H. Sie können keine &quot;Kette&quot; von beschworenen Einheiten platzieren). Sie dürfen nicht in der Kontrollzone einer feindlichen Einheit oder in unpassierbarem Gelände aufgestellt werden. Die Art der Einheit, die beschworen werden kann, hängt von der Fraktion der Beschwörungsformation ab.  • Beschworene Einheiten zählen für alle Regeln als Teil der Formation, solange sie auf dem Schlachtfeld bleiben. Beschworene Einheiten sind Verbrauchsgegenstände, werden aber ansonsten als normale Einheiten gezählt und werden bei der Berechnung berücksichtigt, wenn eine Formation einen Gegner bei einem Angriff überzählt oder durch Blast-Marker usw. gebrochen wird. Beachten Sie, dass Dämonen, die bei einem Angriff getötet werden, beim Ermitteln von Modifikatoren für die Angriffsauflösung zählen. Wenn eine Formation einen Angriff verliert, entfernen Sie zusätzliche Treffer aus der Formation, bevor sie gebrochen wird, und alle verbleibenden beschworenen Einheiten werden dann entfernt.  • Beschworene Einheiten bleiben bis zum Ende des Zuges auf dem Schlachtfeld, in dem sie beschworen wurden. Am Ende der Rallye-Phase, nachdem die Formationen versucht haben, sich zu sammeln, werden alle in der Formation beschworenen Einheiten vom Brett entfernt und wieder in den Dämonenpool gelegt, sofern die Formation keine Einheit mit Dämonischem Fokus hat. Große Dämonen, die in den Dämonenpool zurückkehren, behalten den gleichen DC, den sie hatten, als sie das Schlachtfeld verließen. Sie heilen nicht bis zum vollen DC zurück, so dass sie, wenn sie erneut beschworen werden, denselben DC haben werden. Zerstörte beschworene Einheiten werden nicht in den Dämonenpool zurückgelegt. Beachten Sie, dass dies zum Bruch der Formation führen kann, wenn die Anzahl der Blast-Marker in der Formation größer ist als die Anzahl der im Spiel verbleibenden Einheiten, nachdem die beschworenen Einheiten entfernt wurden. Wenn eine Formation zerbricht, werden alle in der Formation beschworenen Einheiten im Warp verloren und als zerstört betrachtet. Sie gehen nicht zurück in den Dämonenpool.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Unités Convoquées: Les formations qui achètent l&apos;amélioration Pacte Démoniaque sont capables d&apos;invoquer des démons sur le champ de bataille.  • Les démons de la Réserve de Démons sont achetés et notés uniquement comme étant des démons plus ou moins grands, et non par leur faction. La faction de la formation d&apos;invocation dicte les types de démons qui peuvent être invoqués. Les joueurs doivent soit écrire le contenu de leur réserve de démons, soit utiliser des jetons pour indiquer le nombre de démons plus ou moins grands qu&apos;ils peuvent invoquer au cours d&apos;une partie. L&apos;adversaire du joueur du Chaos peut toujours voir le nombre de Démons Mineurs et de Démons Majeurs restant dans la Réserve de Démons. La Réserve de Démons est maintenu hors du plateau de jeu et les démons en sont retirés au fur et à mesure que les formations invoquent des démons sur le plateau de jeu.  • Au début de l&apos;action de cette formation, avant que le test d&apos;action ne soit effectué, la formation peut invoquer des unités de démons de la Réserve de Démons. L&apos;invocation vous permet d&apos;invoquer 2d3 points d&apos;invocation d&apos;unités démoniaques sur le champ de bataille (le nombre de points d&apos;invocation qu&apos;il en coûte pour invoquer une unité est indiqué ci-dessous entre parenthèses après chaque unité). Les points d&apos;invocation doivent être utilisés pour invoquer des unités démoniaques de la Réserve de Démons et les unités invoquées sont immédiatement mises en jeu. Si, pour une raison quelconque, les points d&apos;invocation générés ne sont pas utilisés, ils sont perdus et ne peuvent être reportés aux tours suivants. Vous ne pouvez invoquer qu&apos;autant de démons qu&apos;il vous reste dans votre Réserve de Démons. Les unités de démons restantes peuvent être invoquées lors d&apos;un tour ultérieur. Les unités démoniaques qui sont détruites sont retirées du jeu et ne sont pas replacées dans la réserve de démons. Les formations brisées ou les formations qui n&apos;ont pas acheté un pacte démoniaque ne peuvent pas invoquer de démons.  • Les joueurs ne peuvent avoir qu&apos;un seul Démon Majeur d&apos;une faction donnée de l&apos;armée sur le plateau de jeu à la fois. Par exemple, si vous avez déjà invoqué un Buveur de Sang sur le plateau de jeu, vous ne pouvez pas en invoquer un autre avant que le premier démon plus grand n&apos;ait été retiré du jeu. Les unités invoquées doivent être installées avec leur base à moins de 5 cm de toute unité non démoniaque de leur formation, (c&apos;est-à-dire que vous ne pouvez pas placer une &quot;chaîne&quot; d&apos;unités invoquées). Elles ne peuvent pas être installées dans la zone de contrôle d&apos;une unité ennemie ou en terrain impraticable. Le type d&apos;unité qui peut être invoquée dépend de la faction de la formation qui l&apos;invoque.  • Les unités invoquées comptent comme faisant partie de la formation pour toutes les règles tant qu&apos;elles restent sur le champ de bataille. Les unités invoquées sont Sacrifiables, mais elles sont par ailleurs comptées comme des unités normales, et sont incluses lors de l&apos;entraînement si une formation est plus nombreuse qu&apos;un adversaire lors d&apos;un assaut ou si elle est démoralisée par des pions d&apos;impact, etc. Notez que les Daemons tués lors d&apos;un assaut sont pris en compte dans le nombre d&apos;unités tuées par l&apos;ennemi lors de l&apos;élaboration des modificateurs pour la résolution de l&apos;assaut. Si une formation perd un assaut, retirez les tués supplémentaires de la formation avant qu&apos;elle ne soit démoralisée et toutes les unités restantes qui ont été invoquées sont alors retirées.  • Les unités invoquées restent sur le champ de bataille jusqu&apos;à la phase finale du tour où elles sont invoquées. A la fin de la phase de ralliement, après que les formations aient tenté de se rallier, toutes les unités invoquées de la formation sont retirées du tableau et replacées dans la Réserve de Démons, sauf si la formation possède une unité à Mise au Point Démoniaque. Les Démons Majeurs qui sont replacés dans la Réserve de Démons conservent le même CD qu&apos;ils avaient lorsqu&apos;ils ont quitté le champ de bataille. Ils ne guérissent pas pour revenir à un CD complet, donc lorsqu&apos;ils sont à nouveau convoqués, ils ont le même CD. Les unités invoquées qui sont détruites ne sont pas replacées dans la Réserve de Démons. Notez que cela peut entraîner la rupture de la formation si le nombre de pions d&apos;impact sur la formation est supérieur au nombre d&apos;unités en jeu après que les unités invoquées aient été retirées. Lorsqu&apos;une formation se brise, toutes les unités invoquées de la formation sont perdues dans le warp et considérées comme détruites. Elles ne retournent pas dans la Réserve de Démons.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Formations that purchase the Daemonic Pact upgrade are able to summon daemons to the battlefield.
...
Summoned units remain on the battlefield until the end phase of the turn in which they are summoned. In the end of the rally phase, after formations have attempted to rally, all summoned units in the formation are removed from the board and placed back into the Daemon Pool unless the formation has a unit with Daemonic Focus. Greater Daemons that are returned to the Daemon Pool keep the same DC they had when they left the battlefield. They do not heal back to full DC, so when summoned again they will have that same DC. Summoned units that are destroyed are not put back into the Daemon Pool. Note that this may lead to the formation breaking if the number of Blast markers on the formation is greater than the number of units left in play after the summoned units have been removed. When a formation breaks any summoned units in the formation are lost in the warp and considered destroyed. They do not go back into the Daemon Pool.</description>
    ...
    <rule id="5772-ec01-0ab3-ac43" name="Summoning of Daemons" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Invocation de Demons: L’amélioration Porte-icône permet, lors de la phase de Téléportation, d’invoquer une formation de démons préalablement sélectionnée lors de la composition de l’armée. La formation accueillant le porte-icône et la formation invoquée doivent appartenir à la même faction. La formation invoquée apparaît à moins de 15cm du porte-icône. Si le porte-icône est éliminé, les démons ne peuvent plus être invoqués par cette formation. On ne peut invoquer qu&apos;une seule formation de démons par porte-icône et par partie. Une formation s’étant téléportée ce tour-ci ne peut pas invoquer de démons. La formation invoquée ne subit pas de PI suite à sa « téléportation ». Elle devient immédiatement une formation à part entière et suit les règles d’activation, de cohésion, etc. Elle reste ensuite en jeu jusqu’à la fin de la partie ou jusqu’à sa destruction.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Beschwörung von Dämonen: Das Ikonenträger-Upgrade ermöglicht es, während der Teleport-Phase eine Formation von Dämonen zu beschwören, die zuvor bei der Zusammensetzung der Armee ausgewählt wurden. Die Formation, in der sich der Ikonenträger befindet, und die aufgerufene Formation müssen derselben Fraktion angehören. Die aufgerufene Formation erscheint innerhalb von 15 cm des Ikonenträger. Wenn der Ikonenträger eliminiert wird, können die Dämonen durch diese Formation nicht mehr beschworen werden. Es kann nur eine Dämonenformation pro Ikonenträger pro Spiel aufgerufen werden. Eine Formation, die sich in dieser Runde teleportiert hat, kann keine Dämonen beschwören. Die aufgerufene Formation erhält nach ihrer &quot;Teleportation&quot; keinen Blast-Marker. Es wird sofort zu einer eigenen Formation und folgt den Regeln der Aktivierung, des Zusammenhalts usw. Es bleibt dann bis zum Ende des Spiels oder bis zu seiner Zerstörung im Spiel.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Invocación de Demonios: La mejora de Portador del Icono permite, durante la fase de Teletransporte, convocar una formación de demonios que fueron previamente seleccionados durante la composición del ejército. La formación que alberga al Portador del Icono y la formación invocada deben pertenecer a la misma facción. La formación invocada aparece a menos de 15 cm del Portador del Icono. Si el Portador del Icono es eliminado, los demonios ya no pueden ser invocados por esta formación. Sólo se puede invocar una formación de demonios por Portador del Icono por juego. Una formación que se ha teletransportado este turno no puede invocar demonios. La formación invocada no toma un marcador de explosión después de su &quot;teletransportación&quot;. Se convierte inmediatamente en una formación por derecho propio y sigue las reglas de activación, coherencia, etc. Luego permanece en juego hasta el final del juego o hasta su destrucción.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>The Icon-Bearer enhancement allows, during the Teleport phase, to summon a formation of daemons previously selected during the composition of the army. The formation hosting the icon bearer and the formation invoked must belong to the same faction. The invoked formation appears within 15cm of the icon bearer. If the icon bearer is eliminated, the daemons can no longer be summoned by this formation. Only one formation of daemons per icon-bearer per game can be invoked. A formation that has teleported this turn cannot summon daemons. The formation invoked does not take a blast marker following its &quot;teleportation&quot;. It immediately becomes a formation in its own right and follows the rules of activation, cohesion, etc. It then remains in play until the end of the game or until its destruction.</description>
    </rule>
    <rule id="906b-85f7-c144-87ad" name="Dreadclaws" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Garra de Muerte: Después de que la garra de muerte aterrice, su Deathwind ataca a todas las unidades enemigas en un radio de 15cms. Cada formación enemiga atacada recibe un Marcador de Explosión por estar bajo fuego, y un Marcador de Explosión adicional por cada baja como es normal. Entonces cualquier tropa llevada en la Garra de Muerte debe desembarcar a menos de 5cms de la Garra de Muerte o a menos de 5cms de otra unidad de la misma formación que ya ha desembarcado, siempre que todas las unidades se coloquen a menos de 15cms de la Garra de Muerte. El modelo de garra de muerte sólo se usa como un marcador y no cuenta como una unidad en ningún aspecto. No puede ser usado para reclamar fuego cruzado y el valor del blindaje es sólo para propósitos comparativos.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Taranteln: Taranteln: Nachdem die Tarantel gelandet ist, greift ihr Deathwind alle feindlichen Einheiten innerhalb von 15 cm an. Jede feindliche Formation, die angegriffen wird, erhält einen Blast-Marker, wenn sie unter Beschuss gerät, und einen zusätzlichen Blast-Marker für jedes Todesopfer wie üblich. Dann müssen alle Truppen, die in der Tarantel getragen werden, innerhalb von 5 cm von der Tarantel oder innerhalb von 5 cm von einer anderen Einheit derselben Formation, die bereits gelandet ist, von Bord gehen, solange alle Einheiten innerhalb von 15 cm von der Tarantel platziert sind. Das Tarantel-Modell wird nur als Markierung verwendet und zählt in keiner Weise als Einheit. Es darf nicht verwendet werden, um Kreuzfeuer zu beanspruchen, und der Panzerungswert dient nur zu Vergleichszwecken.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Module d&apos;Assaut Dreadclaw: Après l&apos;atterrissage du Dreadclaw, son Deathwind attaque toutes les unités ennemies dans un rayon de 15cms. Chaque formation ennemie attaquée reçoit un pion d&apos;impact pour avoir été sous le feu, et un pion d&apos;impact supplémentaire pour chaque victime, comme d&apos;habitude. Ensuite, toute troupe transportée dans le Dreadclaw doit débarquer dans un rayon de 5 cm du Dreadclaw ou dans un rayon de 5 cm d&apos;une autre unité de la même formation qui a déjà débarqué, tant que toutes les unités sont placées dans un rayon de 15 cm du Dreadclaw. Le modèle de Dreadclaw n&apos;est utilisé que comme marqueur et ne compte en aucun cas comme une unité. Il ne peut pas être utilisé pour réclamer des feux croisés et la valeur du blindage n&apos;est donnée qu&apos;à titre de comparaison.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>After the Dreadclaw lands, its Deathwind attacks all enemy units within 15cms. Each enemy formation attacked receives a Blast marker for coming under fire, and an extra Blast marker for each casualty as normal. Then any troops carried in the Dreadclaw must disembark within 5cms of the Dreadclaw or within 5cms of another unit from the same formation that has already landed, so long as all units are placed within 15cms of the Dreadclaw. The Dreadclaw model is only used as a marker and does not count as a unit in any respect. It may not be used to claim crossfire and the armour value is for comparative purposes only.</description>
    </rule>
    <rule id="c45d-156c-4de1-bf45" name="Dreadclaws (EpicUK)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Garra de Muerte: Las garras de muerte permiten que una formación de caos entre en juego usando las reglas de caída orbital si se ha comprado una nave espacial para llevarlas. Las unidades en una formación con garras de muerte se despliegan usando las reglas de caída orbital pero no tiran para la dispersión. Ponga la primera unidad dentro de los 15cm de las coordenadas anotadas de la zona de caída y ponga todas las demás unidades de la formación dentro de los 15cm de esta unidad y en coherencia. Las unidades no pueden colocarse en terreno intransitable o en zonas enemigas de control.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Taranteln: Taranteln erlauben es einer Chaosformation, unter Anwendung der Planetenfall-Regeln ins Spiel zu kommen, wenn ein Raumschiff gekauft wurde, um sie zu transportieren. Einheiten in einer Formation mit Taranteln entfalten sich nach den Planetenfall-Regeln, würfeln aber nicht für Zufallsbewegung. Platzieren Sie die erste Einheit im Umkreis von 15 cm von den vorher festgelegten Koordinaten der Abwurfzone und platzieren Sie alle anderen Einheiten in der Formation im Umkreis von 15 cm von dieser Einheit und in Kohärenz. Einheiten dürfen nicht in unpassierbarem Gelände oder in feindlichen Kontrollzonen platziert werden.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Module d&apos;Assaut Dreadclaw: Les Dreadclaws permettent à une formation du chaos d&apos;entrer en jeu en utilisant les règles d&apos;assaut planétaire si un vaisseau spatial a été acheté pour les transporter. Les unités en formation avec des Dreadclaws se déploient en utilisant les règles d&apos;assaut planétaire mais ne font pas de jet de dispersion. Placez la première unité à moins de 15 cm des coordonnées de la zone de largage prédéfinie et placez toutes les autres unités de la formation à moins de 15 cm de cette unité et en cohérence. Les unités ne peuvent pas être placées en terrain impraticable ou dans des zones de contrôle ennemies.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Dreadclaws allow a chaos formation to enter play using the planetfall rules if a spaceship has been purchased to carry them. Units in a formation with Dreadclaws deploy using the planetfall rules but do not roll for scatter. Place the first unit within 15cm of the pre-plotted drop zone co-ordinates and place all other units in the formation within 15cm of this unit and in coherency. Units may not be placed in impassable terrain or enemy zones of control.</description>
    </rule>
    <rule id="141f-fed4-6d70-0fb5" name="Dreadclaws (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Modules d&apos;Atterrissage Dreadclaw: Une formation se déployant par Assaut Planétaire et pouvant être transportée par Modules d’atterrissage Dreadclaw le fait selon les règles spéciales suivantes :   • Placez un marqueur de Module d’atterrissage en utilisant les règles d’Assaut Planétaire. Un Vaisseau en orbite sera nécessaire pour déployer les Modules d’atterrissage.   • Le Module d’atterrissage est un marqueur comptant comme la première unité de la formation au moment de déterminer son emplacement d’arrivée en Assaut Planétaire. Une fois le marqueur de Module d’atterrissage placé, résolvez son attaque de tir sur toutes les unités ennemies à moins de 15 cm du centre du Module d’atterrissage. Chaque formation ennemie attaquée reçoit un Pion Impact selon les règles normales de tir.   • Ensuite, débarquez les troupes transportées dans le Module d’atterrissage (cela peut déclencher un tir d’État d’Alerte normalement) complètement à moins de 15 cm du centre de celui-ci, en cohésion et en dehors de toute zone de contrôle ennemie. Si les unités ne peuvent débarquer en totalité en respectant les règles ci-dessus, les unités restantes seront détruites sans attribution de pions d&apos;impacts.   • Le Module d’atterrissage n&apos;étant pas une unité mais un marqueur, il ne possède pas de zone de contrôle et il ne compte pas pour la cohérence de la formation. De plus, il ne peut pas être utilisé pour revendiquer un feu croisé ainsi que pour tenir ou contester des objectifs.   • Si plusieurs formations utilisent des Modules d’atterrissage, placez tous les marqueurs Module d’atterrissage aux coordonnées prédéterminées en utilisant les règles d’Assaut Planétaire (y compris la résolution de dispersion). Une fois que tous les marqueurs sont placés, résolvez toutes les attaques des Modules d’atterrissage simultanément contre les formations ennemies à portée des marqueurs Module d’atterrissage. Les formations visées recevront un pion impact pour le tir pour chaque attaque du vaisseau ou des modules d&apos;atterrissage. Les pertes et les tirs ruptures infligent des PI normalement. Puis débarquez toutes les formations transportées, en suivant les règles ci-dessus.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Garra de Muerte: Para desplegar una formación usando garras de muerte, coloca un &quot;marcador de garra de muerte&quot; usando las reglas de Caída Orbital. La garra de muerte es un marcador que cuenta como la primera unidad de la formación cuando se determina su zona de caída en la Caída Orbital. Una vez que se coloca el marcador de garra de muerte, su Deathwind dispara a todas las unidades enemigas a menos de 15 cm del centro de la garra de muerte. Cada formación enemiga que es atacada recibe un Marcador de Explosión según las reglas normales de disparo.  • Luego, se desembarca a las tropas transportadas en la Garra de la Muerte (esto puede provocar Fuego de Supresión como es habitual) completamente dentro de los 15 cm del centro de la misma, en coherencia y fuera de cualquier zona de control enemiga. Si las unidades no pueden desembarcar en su totalidad de acuerdo con las reglas anteriores, las unidades restantes serán destruidas sin otorgar marcadores de explosión.  • La Garra de Muerte no es una unidad sino un marcador, no tiene zona de control y no cuenta para la coherencia de la formación. Además, no se puede utilizar para reclamar un tiroteo, ni para capturar o disputar objetivos.  • Si varias formaciones usan garras de muerte, coloca todos los marcadores de garras de muerte en coordenadas predeterminadas usando las reglas de Caída Orbital (incluyendo la resolución de la dispersión). Una vez que se hayan colocado todos los marcadores, resuelve todos los ataques de Viento Mortal simultáneamente contra las formaciones enemigas dentro del rango de los marcadores de Garra de Muerte. Las formaciones objetivo recibirán un marcador de explosión por cada ataque a la nave o a los desembarcaderos. Las bajas y Disrupción infligen Marcadores de Explosión normalmente, y luego desembarca todas las formaciones transportadas, siguiendo las reglas anteriores.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Taranteln: Um eine Formation unter Verwendung von Taranteln aufzustellen, platzieren Sie eine &quot;Tarantelmarkierung&quot; unter Verwendung der Planetfall-Regeln. Die Tarantel ist eine Markierung, die als erste Einheit der Formation zählt, wenn ihre Abwurfzone in Planetfall bestimmt wird. Sobald die Tarantel-Markierung platziert ist, feuert ihr Deathwind auf alle feindlichen Einheiten im Umkreis von 15 cm vom Zentrum der Tarantel. Jede feindliche Formation, die angegriffen wird, erhält einen Blast-Marker gemäß den normalen Schießregeln.  • Dann werden die in der Tarantel transportierten Truppen (dies kann wie üblich eine Überwachen auslösen) im Umkreis von 15 cm um das Zentrum der Tarantel, in Kohärenz und außerhalb jeder feindlichen Kontrollzone vollständig ausgeschifft. Wenn nicht alle Einheiten nach den oben genannten Regeln landen können, werden die verbleibenden Einheiten ohne Zuteilung von Blast-Markern vernichtet.  • Die Tarantel ist keine Einheit, sondern eine Markierung, sie hat keine Kontrollzone und zählt nicht für die Kohärenz der Formation. Darüber hinaus kann sie nicht dazu verwendet werden, ein Kreuzfeuer zu beanspruchen oder Ziele einzunehmen oder zu bekämpfen.  • Wenn mehrere Formationen Taranteln verwenden, platzieren Sie alle Tarantelmarkierungen unter Verwendung der Planetfallregeln (einschließlich der Streuungsauflösung) an vorgegebenen Koordinaten. Sobald alle Markierungen gesetzt sind, lösen Sie alle Deathwind-Angriffe gleichzeitig gegen feindliche Formationen auf, die sich in Reichweite der Tarantelmarkierungen befinden. Die anvisierten Verbände erhalten für jeden Angriff auf das Schiff oder die Landemodule einen Blast-Marker für Beschuss. Verluste und Disruptor-Waffen fügen normal BM zu, und verlassen Sie dann alle transportierten Formationen unter Beachtung der obigen Regeln.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>A formation deploying by Planetfall that can be transported by Dreadclaw Drop Pods does so under the following special rules:
Place a Drop Pod marker using the Planetfall rules. An orbiting ship will be required to deploy the Landing Pods.
The Drop Pod is a marker that counts as the first unit in the formation when determining its Planetfall arrival location. Once the Drop Pod marker is placed, resolve its fire attack on all enemy units within 15cm of the centre of the Drop Pod. Each enemy formation attacked receives a Blast Marker according to the normal fire rules.
Next, disembark the troops being transported in the Drop Pod (this can trigger Overwatch as normal) completely within 15cm of the centre of the Drop Pod, within coherence and outside any enemy zone of control. If the units cannot disembark in full according to the above rules, the remaining units will be destroyed without awarding Blast Markers.
As the Drop Pod is not a unit but a marker, it does not have a control area and does not count for formation coherence. Furthermore, it cannot be used to claim crossfire or to hold or contest objectives.
If multiple formations are using Drop Pods, place all Drop Pod markers at the predetermined coordinates using the Planetfall rules (including scatter resolution). Once all markers are placed, resolve all Drop Pod attacks simultaneously against enemy formations within range of the Drop Pod markers. Targeted formations will receive one Blast Marker for each ship or Drop Pod attack. Casualties and weapons with Disrupt inflict BM as normal. Then disembark all transported formations, following the rules above.</description>
    </rule>
    <rule id="07a4-dfbd-64a5-4270" name="Dreadclaws (NetEA)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Garra de Muerte: La Garra de Muerte no se dispersa 2D6cm después de ser colocada a 15cm de las coordenadas anotadas como punto de caída orbital. Las unidades transportadas deben desembarcar a 5cm de la Garra de Muerte o de una unidad ya desplegada, siempre que ninguna unidad quede a más de 15cm de la Garra de Muerte. Las miniaturas de Garra de Muerte deberían retirarse al final del proceso de desembarco.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Taranteln: Die Tarantula, alias Schreckensklaue, landet innerhalb von 15 cm von den Drop-Zone-Koordinaten, die zu Beginn des Spiels aufgezeichnet wurden. Beachten Sie, dass es sich nach dem Platzieren nicht um 2W6cm in zufälliger Richtung bewegt. Alle Truppen, die in der Tarantel befördert werden, müssen innerhalb von 5 cm vor der Tarantel oder innerhalb von 5 cm von einer anderen Einheit aus derselben Formation, die bereits gelandet ist, aussteigen, sofern sich alle Einheiten innerhalb von 15 cm der Tarantel befinden. Tarantel-Modelle sollten vom Board entfernt werden, sobald die von ihnen transportierte Formation von Bord gegangen ist.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Module d&apos;Assaut Dreadclaw: Le Dreadclaw ne se disperse pas 2d6cm après avoir été placé à moins de 15cm des coordonnées de la zone de chute enregistrées au début du jeu. Toute troupe transportée dans le Dreadclaw doit débarquer à moins de 5 cm du Dreadclaw ou à moins de 5 cm d&apos;une autre unité de la même formation qui a déjà débarqué, à condition que toutes les unités soient placées à moins de 15 cm du Dreadclaw. Les Dreadclaws doivent être retirés de la table une fois que la formation qu&apos;ils transportent a débarqué.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>The Dreadclaw does not scatter 2d6cm after being placed within 15cm of the drop zone co-ordinates recorded at the start of the game. Any troops carried in the Dreadclaw must disembark within 5cm of the Dreadclaw or within 5cm of another unit from the same formation that has already landed, so long as all units are placed within 15cm of the Dreadclaw. Dreadclaw models should be removed from the board once the formation they transport has disembarked.</description>
    </rule>
    <rule id="04d3-3951-4b6f-b140" name="Summoning of Units" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Invocation d&apos;Unités: L’invocation des démons peut se faire via deux modes. Ces deux modes ne sont pas cumulables dans le même tour par une même formation :  • 1°) Soit une Invocation via le Pacte Démoniaque lors de la phase de téléportation:  • Le joueur invoque alors une formation de Démons Mineurs ou un Démon Majeur. Lesdits démons apparaissent dans les 15cm de l’unité invocatrice ayant la même affiliation que le type de démons invoqués. Cette formation de démons reste ensuite en jeu jusqu’à la fin de la partie ou jusqu’à sa destruction.  • Cette formation devient immédiatement une formation à part entière et suit les règles d’activation, de cohésion, etc.  • 2°) Soit les démons apparaissent via la Concentration Démoniaque (X) au moment de l’activation de la formation invocatrice et avant que celle-ci ne fasse son jet d’activation.  • X Démons Mineurs affiliés à la formation invocatrice sont alors invoqués dans la formation. Tous les démons ainsi invoqués doivent être placés à 5cm de l’unité invocatrice ayant la même affiliation que le type de démons invoqués. Cette invocation est unique (la formation ne pourra plus invoquer de démons de cette manière durant le reste de la partie), les démons restent attachés à la formation invocatrice jusqu’à la fin de la partie, ou jusqu’à leur destruction.  • Les démons et la formation devenant ainsi une seule et même formation suivant toutes les règles de cohésion, d’activation, etc.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Beschwörung von Einheiten: Der Aufruf der Dämonen kann über zwei Modi erfolgen. Zwei Modi können nicht durch dieselbe Formation in derselben Runde kombiniert werden:  • 1 °) Anrufung über den Dämonenpakt während der Teleportationsphase:  • Der Spieler ruft dann eine Formation von Niederer Dämonen oder Größer Dämonen auf. Diese Dämonen erscheinen innerhalb von 15 cm von der Beschwörungseinheit mit der gleichen Zugehörigkeit wie die Art der beschworenen Dämonen. Diese Bildung von Dämonen bleibt dann bis zum Ende des Spiels oder bis zu seiner Zerstörung im Spiel.  • Diese Formation wird sofort zu einer eigenen Formation und folgt den Regeln der Aktivierung, des Zusammenhalts usw.  • 2 °) Lassen Sie die Dämonen über den Dämonenfokus (X) erscheinen im Moment der Aktivierung der Invokationsformation, bevor sie aktiviert wird.  • X Niederer Dämonen, die mit der Beschwörungsformation verbunden sind, werden dann in die Formation beschworen. Alle so beschworenen Dämonen müssen sich innerhalb von 5 cm von der Beschwörungseinheit befinden und der gleichen Zugehörigkeit wie die Art der beschworenen Dämonen entsprechen. Diese Beschwörung ist einzigartig (die Formation kann für den Rest des Spiels keine Dämonen mehr auf diese Weise beschwören). Die Dämonen bleiben bis zum Ende des Spiels an der beschwörenden Formation gebunden oder bis sie zerstört werden.  • Die Dämonen und die Formation werden nach allen Regeln des Zusammenhalts, der Aktivierung usw. zu ein und derselben Formation.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Invocación de Unidades: La invocación de los demonios puede hacerse de dos maneras. Dos modos no pueden ser combinados en la misma ronda por la misma formación:  •   • 1 °) Invocación a través del Pacto Demoníaco durante la fase de teletransportación:  • El jugador invoca entonces una formación de Demonios Menores o un Gran Demonio. Estos demonios aparecen a menos de 15 cm de la unidad invocadora con la misma afiliación que el tipo de demonios invocados. Esta formación de demonios permanece en juego hasta el final del juego o hasta su destrucción.  • Esta formación se convierte inmediatamente en una formación por derecho propio y sigue las reglas de activación, cohesión, etc.  •   • 2 °) Dejar que los demonios aparezcan a través del Foco Demoníaco (X) en el momento de la activación de la formación invocadora, antes de que ésta haga su rodaje de activación.  • X demonios menores afiliados a la formación invocadora son entonces convocados en la formación. Todos los demonios así invocados deben colocarse a menos de 5cm de la unidad invocadora con la misma afiliación que el tipo de demonios invocados. Esta invocación es única (la formación ya no podrá invocar a los demonios de esta forma durante el resto del juego), los demonios permanecen unidos a la formación invocadora hasta el final del juego, o hasta que son destruidos.  • Los demonios y la formación se convierten así en una misma formación según todas las reglas de cohesión, activación, etc.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>The invocation of the daemons can be done via two modes. Two modes can not be combined in the same round by the same formation:
1 °) Invocation via the Daemonic Pact during the teleportation phase:
The player then invokes a formation of Minor Daemons or a Major Daemon. These daemons appear within 15cm of the summoning unit with the same affiliation as the type of daemons invoked. This formation of daemons then remains in play until the end of the game or until its destruction.
This formation immediately becomes a formation in its own right and follows the rules of activation, cohesion, etc.
2 °) Let the daemons appear via Daemonic Focus (X) at the moment of the activation of the invocative formation, before it makes its activation roll.
X Minor Daemons affiliated with the summoning formation are then summoned in the formation. All daemons so summoned must be placed within 5cm of the summoning unit with the same affiliation as the type of daemons summoned. This summoning is unique (the formation will no longer be able to summon daemons in this way for the rest of the game), the daemons remain attached to the summoning formation until the end of the game, or until they are destroyed.
The daemons and the formation thus becoming one and the same formation according to all the rules of cohesion, activation, etc.</description>
    </rule>
    <rule id="bbcf-b87e-fab1-1879" name="Rules for Greater &amp; Lesser Daemons" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Règles des Démons Majeurs et Mineurs: Sacrifiables: Certaines unités sont perçues par leurs alliés comme « sacrifiables ». Soit car elles ont été spécialement créées pour se sacrifier ou soit car ces unités n&apos;ont simplement pas de valeur aux yeux de leurs alliés. Les unités qui sont considérées comme Sacrifiables, ne génèrent pas de pions d&apos;impact lorsqu&apos;elles sont détruites. Ceci inclut les effets spéciaux créant des pions d&apos;impact lorsqu’une unité sacrifiable est ciblée, c’est-à-dire lorsque les touches sont allouées à l&apos;unité. Cependant, les unités Sacrifiables comptent dans le calcul des pertes lors de la résolution d&apos;un assaut.  • Instable: si les démons sont démoralisés ils sont détruits.  • Ne peuvent que contester les objectifs.  • Téléportation avec une exception: à 15cm maximum d&apos;une unité invocatrice (Démagogue ou Pacte Démoniaque). Les démons ne subissent pas de PI suite à la téléportation.  • On ne peut invoquer qu&apos;une seule formation de démons par formation &quot;invocatrice&quot;. Une formation venant de se téléporter ne peut invoquer des démons via un Pacte Démoniaque (mais elle le peut via un Champion des Dieux Sombres). Les Démons invoqués doivent appartenir à la même faction que la formation invocatrice.  • Les joueurs ne sont autorisés à invoquer qu ‘un seul Démon Majeur par Faction. Donc si vous avez déjà invoqué un Buveur de Sang vous n’êtes pas autorisé à en invoquer un autre tant que ce Démon Majeur n’a pas été retiré du jeu.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Regeln für Größere &amp; Niedere Dämonen: Opferbereitschaft: Einige Einheiten werden von ihren Verbündeten als &quot;opferbereit&quot; empfunden. Entweder weil sie speziell geschaffen wurden, um sich selbst zu opfern, oder weil diese Einheiten in den Augen ihrer Verbündeten einfach keinen Wert haben. Opfereinheiten erzeugen keinen Blast-Marker, wenn sie zerstört werden. Dies schließt Spezialeffekte ein, die Blast-Marker erzeugen, wenn eine Opfereinheit als Ziel ausgewählt wird, d. H. Wenn der Einheit Treffer zugewiesen werden. Opfereinheiten zählen jedoch bei der Berechnung von Verlusten bei der Lösung eines Angriffs.  • Instabil: Wenn die Dämonen zerbrochen sind, werden sie zerstört.  • Darf Ziele nur herausfordern, nicht kontrollieren.  • Die Teleportation kann bis zu 15 cm von einer Formation mit einem Dämonischer Pakt entfernt sein und erhält aufgrund der Teleportation keinen Blast-Marker.  • Es kann nur eine Dämonenformation pro aufrufender Formation aufgerufen werden. Eine Teleportationsformation kann keine Dämonen über einen Dämonischer Pakt beschwören (dies kann jedoch über einen Ikonenträger geschehen). Beschworene Dämonen gehören immer derselben Fraktion an wie die Beschwörungsformation.  • Spieler dürfen nur einen großer dämon pro Fraktion beschwören. Wenn Sie also bereits einen Blutdämon beschworen haben, dürfen Sie keinen weiteren beschwören, bis dieser großer dämon aus dem Spiel entfernt wurde.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Las Reglas de los Demonios Grandes y Menores: Sacrificable: algunas unidades son percibidas por sus aliados como &quot;sacrificables&quot;. Ya sea porque fueron creadas especialmente para sacrificarse a sí mismas, o porque estas unidades simplemente no tienen valor a los ojos de sus aliados. Las unidades sacrificables no generan un marcador de explosión cuando son destruidas. Esto incluye los efectos especiales que crean marcadores de explosión cuando se apunta a una unidad de sacrificio, es decir, cuando se asignan impactos a la unidad. Sin embargo, las unidades que se sacrifican cuentan en el cálculo de pérdidas cuando se resuelve un asalto.  • Inestable: Si los demonios están desmoralizados, son destruidos.  • Sólo pueden disputar objetivos, no controlarlos.  • La teletransportación puede ser hasta un máximo de 15 cm. de la unidad invocadora (Demagogo o Pacto Demoníaco), y no reciben un marcador de explosión debido a la &quot;teletransportación&quot;.  • Sólo se puede invocar una formación de demonios por formación invocadora. Una formación teletransportadora no puede invocar demonios a través de un Pacto Demoníaco (pero puede hacerlo a través de un Campeón de los Dioses Oscuros). Los Demonios invocados siempre pertenecen a la misma facción que la formación invocadora.  • Los jugadores sólo pueden invocar un Gran Demonio por facción. Por lo tanto, si ya has invocado a un Devorador de Almas, no puedes invocar a otro hasta que este Gran Demonio haya sido eliminado del juego.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Sacrificial: some units are perceived by their allies as &quot;sacrificable&quot;. Either because they were specially created to sacrifice themselves, or because these units simply do not have value in the eyes of their allies. Sacrificial units do not generate a blast marker when destroyed. This includes special effects that create blast markers when a Sacrificial unit is targeted, i.e. when hits are allocated to the unit. However, Sacrificial units count in calculating losses when resolving an assault.
Unstable: If the daemons are broken, they are destroyed.
May only contest objectives, not control them.
Teleportation may be up to 15cm max from the summoning unit (Demagogue or Daemonic Pact), and do not take a blast marker due to &quot;teleportation&quot;.
Only one formation of daemons per invocative formation can be invoked. A teleporting formation can not summon demons via a Daemonic Pact (but it can do so through a Champion of the Dark Gods). Summoned Daemons always belong to the same faction as the summoning formation.
Players are only allowed to summon one Major Daemon per Faction. So if you have already summoned a Blood Thirster you are not allowed to summon another until this Major Demon has been removed from the game.</description>
    </rule>
    <rule id="1124-354e-4918-3e7b" name="Bloodride" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Tour de Sang: Test de terrain dangereux nécessaire pour l&apos;embarquement.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Viaje de Sangre: Se requiere un chequeo de terreno peligroso para embarcar.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Blutritt: Zum Einschiffen ist ein Test in gefährlichem Gelände erforderlich.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Dangerous terrain test required to embark.</description>
    </rule>
    <rule id="ca08-8168-b276-17e3" name="Blitzkrieg" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Guerre Éclair: Formations contenant une unité avec la capacité Guerre Éclair reçoivent un modificateur de +1 à son jet de test d&apos;action lors de la tentative d&apos;une action de l&apos;avance rapide.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Blitzkrieg: Formationen, die eine Einheit mit der Fähigkeit Blitzkrieg enthalten, erhalten beim Versuch einer Doppelaktion einen Modifikator +1 für ihren Aktionstestwurf.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Blitzkrieg: Las formaciones que contienen una unidad con la capacidad del Blitzkrieg reciben un modificador +1 a su tirada de chequeo de acción cuando intentan una doble acción.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Formations containing a unit with the Blitzkrieg ability receive a +1 modifier to their action test roll when attempting a double action.</description>
    </rule>
    <rule id="1d44-58f4-0d61-38f2" name="Transuranic Arquebus" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Transuranic Arquebus: Uno de cada tres Rangers (redondeado) lleva un arcabuz transuránico. Al realizar una acción de Fuego Sostenido o de Fuego de Supresión, las unidades que usan esta arma aumentan su alcance a 60 cm.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transuranic Arquebus: Un Ranger sur trois (arrondi) transporte un arquebuse transuranien. Lors d&apos;une action de Tir Soutenu, ou d&apos;un tir depuis l&apos;État d&apos;Alerte, les unités utilisant cette arme augmentent leur portée à 60cm.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transuranic Arquebus: Jeder dritte Ranger (aufgerundet) trägt einen Transuranischen Arkebus. Bei einer Dauerfeuer-Aktion oder beim Schießen aus der Überwachen erhöhen Einheiten, die diese Waffe benutzen, ihre Reichweite auf 60 cm.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Every third Ranger (rounded up) carries a Transuranic Arquebus. When taking a Sustained Fire action or firing from Overwatch, units using this weapon increase their range to 60cm.</description>
    </rule>
    <rule id="cef3-1c0e-c931-4177" name="Ion Shield (X)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Bouclier Ionique (X): Les Chevaliers sont protégés par un Bouclier Ionique. Cela leur permet de faire un jet de sauvegarde sur le nombre entre parenthèses quand ils sont touchés par des tirs à distance au lieu d&apos;utiliser leur valeur d&apos;armure.  • Aucun modificateur ne s&apos;applique jamais à ce jet de sauvegarde et il n’est pas affecté par les touches Macro-Arme, Lance et Tueur de Titans (Cependant, chaque point de dégâts d’une touche Tueur de Titans doit être sauvegardé séparément). Si l&apos;unité possède également une armure renforcée, elle est autorisée à relancer une sauvegarde échouée à l&apos;aide de sa valeur d&apos;armure, sauf si la touche est une Macro-Arme, une Lance ou un Tueur de Titans.  • Aucun de ces avantages ne s’applique aux unités participant à des tirs croisés, à des coups provenant de tirs à l’appui ou à des attaques CC (La sauvegarde bouclier ionique peut toujours être utilisée contre les attaques FF. Si nécessaire, lancez les dés CC et FF séparément lorsque vous attaquez des unités équipées de boucliers ioniques).  • Les Boucliers Gantelets Ioniques, les Boucliers Éclater Ioniques et les Égées Ioniques augmentent le sauvegarde de bouclier ionique à 3+.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Escudo de Iones (X): Los caballeros utilizan los escudos de iones para desviar los ataques de disparo. Esto les permite hacer un lanzamiento de ahorro en el número entre paréntesis cuando son alcanzados por el fuego a distancia en lugar de usar su valor de armadura.  • No se aplica ningún modificador a esta tirada de salvamento y no se ve afectada por los impactos de las Macroarmas, Lanzas y el Matatitanes (Sin embargo, cada punto de daño de un impacto del Matatitanes  debe guardarse por separado). Si la unidad tiene una armadura reforzada también, se le permite volver a lanzar una salvada fallida usando su valor de armadura, a menos que el golpe haya sido con una Macro-Arma, Lanza o el Matatitán.  • Ninguno de estos beneficios se aplica a las unidades en un fuego cruzado, impactos de fuego de apoyo o ataques CC (la salvada del Escudo de Iones todavía puede ser usada contra ataques FF. Si es relevante, tira los dados CC y FF por separado al atacar unidades equipadas con Escudos Iónicos).  • Los escudos de guante de iones, los escudos de bengala iónicos y las aegises de iones aumentan el salvamento del escudo de iones a 3+.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Ionenschilde (X): Knights verwenden Ionenschilde, um Schussangriffe abzuwehren. Dadurch können sie bei Fernkampfangriffen einen Rettungswurf auf die Zahl in Klammern ausführen, anstatt ihre Rüstung einzusetzen.  • Für diesen Rettungswurf gelten niemals Modifikatoren, und er ist von Makrowaffen-, Lanzen- und Titan-Killertreffern unbeeinflusst (allerdings muss jeder Schadenspunkt von einem Titan-Killertreffer separat Rettung erfahren). Wenn die Einheit auch über verstärkte Rüstung verfügt, darf sie eine fehlgeschlagene Rettung unter Verwendung ihres Rüstungswertes erneut würfeln, es sei denn, der Treffer war ein Makrowaffen-, Lanzen- oder Titan-Killer-Treffer.  • Keiner dieser Vorteile gilt für Einheiten im Kreuzfeuer, Treffer durch Unterstützungsfeuer oder CC-Angriffe (die Ionenschild-Rettung kann weiterhin gegen FF-Angriffe eingesetzt werden. Falls relevant, würfeln Sie bei Angriffen auf Einheiten, die mit Ionenschilden ausgerüstet sind, getrennt mit CC- und FF-Würfeln).  • Ionen-Gauntlet-Schilde, Ionische Flare-Schilde und Ionen-Aegisen erhöhen die Ionenschild-Rettung auf 3+.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Knights make use of Ion Shields to deflect shooting attacks. This allows them to make a saving throw on the number within brackets when they are hit by ranged fire instead of using their armour value.
...
Ion Gauntlet Shields, Ionic Flare Shields and Ion Aegises increase the Ion Shield Save to 3+.</description>
    </rule>
    <rule id="2b2d-29b7-2ced-78cc" name="Power of the Waaagh! (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="El Poder del ¡Waaaagh!: Las formaciones Orkas que declaren acciones Dobles o de Atacar, recibirán un +2 a su chequeo de acción. A los pilotoz Orkoz, de igual manera, les encanta acribillar cosas, y reciben un +1 para intentar acciones de Ataque a Tierra o Intercepción.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Il Potere della Waaagh!: Le formazioni di Orki che stanno provando ad ingaggiare o a far doppie mosse ricevono un modificatore +2 al loro tiro della prova di azione. Gli Orki aviatori similmente gradiscono l’occasione di sparare alle cose in alto, e ricevono un modificatore di +1 nel loro tiro della prova di azione quando cercano di portare a termine un’azione di intercettamento o di attacco a terra.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="5c97-ef8b-a229-1083" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Pouvoir de la Waaagh: Les Orks ne sont pas de fins stratèges mais la perspective d&apos;une bonne bagarre les galvanisent toujours. Afin de représenter ceci, uneformation tentant une action d&apos;avance rapide ou d&apos;assaut reçoit toujours +2 à l&apos;iniative pour son test d&apos;action.  • Les formations aériennes, ont toujours +1 de bonus pour les tests d&apos;actions lorsqu&apos;elles tentent une Interception ou une Attaque au sol.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Macht der Waaagh!: Ork-Formationen, die versuchen, eine Engage- oder Double-Aktion auszuführen, erhalten einen +2-Modifikator für ihre Aktionstestwurf. Ork-Flyboyz erhalten einen +1-Modifikator für ihren Aktionstestwurf, wenn sie Abfang- oder Bodenangriffsaktionen ausführen.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Ork formations that are attempting to take an engage or double action receive a +2 modifier to their action test roll. Ork flyboyz similarly relish the chance to shoot things up, and receive a +1 modifier to their action test roll when attempting to carry out interception or ground attack actions.</description>
    </rule>
    <rule id="acae-317a-9fe3-4ee1" name="Commissars" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Commissari: Un esercito di Guardia Imperiale della Legione d&apos;Acciaio puo&apos; includere 2D6 Commissari. I Commissari non hanno costo in punti. Se il lancio di dado supera il numero di unita&apos; disponibili ogni scarto sara&apos; perso.  • Tira per vedere quante unita&apos; di Commissari un giocatore puo&apos; aggiungere all&apos;inizio della battaglia prima che entrambe le fazioni abbiano schierato. Se l&apos;esercito include un Comandante Supremo, allora il primo Commissario deve essere unito alla formazione del Comandante Supremo. Ogni altro Commissario puo&apos; essere unito a qualsiasi altra formazione. Non puoi includere piu&apos; di un Commissario per formazione. Se hai più Commissari che formazioni, ogni eccesso è perso.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="5c97-ef8b-a229-1083" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Commissaires: Une armée de la Garde Impériale peut inclure jusqu&apos;à 2D6 commissaires. Les commissaires sont une mise à jour gratuite. Si l&apos;armée comprend un commandant suprême alors le premier commissaire doit être joint à la formation du commandant suprême. Toute autre commissaires peuvent être attachés à d&apos;autres formations. Vous ne pouvez pas inclure plus d&apos;un commissaire par formation. Si vous avez plus que commissaires formations tout excès sont perdus.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Kommissare: Die Imperiale Armee kann bis zu 2W6-Kommissarcharaktere enthalten. Die Kommissare kosten keine Punkte. Kommissar-Einheiten können der Armee zu Beginn der Schlacht hinzugefügt werden, bevor eine der beiden Seiten aufgestellt wird. Wenn die Armee einen Oberbefehlshaber enthält, dann muss das erste Kommissar zu dieser Formation angebracht werden. Sie dürfen nicht mehr als einen Kommissar pro Formation angeben. Wenn Sie mehr Kommissare als Formationen haben, gehen alle Überschüsse verloren.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Comisarios: Un ejército de la Guardia Imperial puede incluir hasta 2D6 personajes de comisario. Los personajes de comisario son una actualización gratuita. Si el ejército incluye un Comandante en Jefe, entonces el primer Comisario debe ser asignado a la formación del Comandante en Jefe. Cualquier otro comisario puede ser asignado a cualquier otra formación. No se puede incluir más de un comisario por formación. Si tienes más Comisarios que las formaciones, cualquier exceso se pierde.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>An Imperial Guard army may include up 2D6 Commissar Characters. The Commissar characters are a free upgrade. If the army includes a Supreme Commander then the first Commissar must be attached to the Supreme Commander’s formation. Any further Commissars may be attached to any other formations. You may not include more than one Commissar per formation. If you have more Commissars than formations any excess are lost.</description>
    </rule>
    <rule id="c25c-c4b8-9622-7ddc" name="Commissars (EpicUK)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Commissaires: La Garde Impériale gagner un personnage de Commissaire libre plus un personnage de Commissaire gratuit supplémentaire par 500 points du scénario. Si l&apos;armée comprend un commandant suprême alors le premier commissaire doit être joint à la formation du commandant suprême. Toute autre commissaire peut-être attaché à d&apos;autres formations. Vous ne pouvez pas inclure plus d&apos;un seul commissaire par formation.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Kommissare: Die Imperiale Armee darf einen Kommissarcharakter pro 500 Punkte in der Armee enthalten. Die Kommissare kosten keine Punkte. Kommissar-Einheiten können der Armee zu Beginn der Schlacht hinzugefügt werden, bevor eine der beiden Seiten aufgestellt wird. Wenn die Armee einen Oberbefehlshaber enthält, dann muss das erste Kommissar zu dieser Formation angebracht werden. Sie dürfen nicht mehr als einen Kommissar pro Formation angeben. Sie können keinen Kommissar zu einer imperialen Verbündetenformation hinzufügen. Wenn Sie mehr Kommissare als Formationen haben, gehen alle Überschüsse verloren.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Comisarios: Un ejército de la Guardia Imperial puede incluir hasta un personaje de comisario por cada quinientos puntos completos. Los personajes del comisario son una mejora gratuita; sin embargo, deben ser modelados apropiadamente para ser incluidos en el ejército.  • Si el ejército incluye un Comandante en Jefe, entonces el primer Comisario debe ser asignado a la formación del Comandante en Jefe. Cualquier otro comisario puede ser asignado a cualquier otra formación. No se puede incluir más de un Comisario por formación. Si tienes más Comisarios que las formaciones, cualquier exceso se pierde. Los Comisarios no pueden ser asignados a unidades de Titanes o de la Armada Imperial.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>An Imperial Guard army may include up to one Commissar Character for each full five hundred points. The Commissar characters are a free upgrade; however they must be appropriately modelled to be included in the army.
If the army includes a Supreme Commander then the first Commissar must be attached to the Supreme Commander’s formation. Any further Commissars may be attached to any other formations. You may not include more than one Commissar per formation. If you have more Commissars than formations any excess are lost. Commissars may not be attached to Titan or Imperial Navy units.</description>
    </rule>
    <rule id="eac4-b26b-cc05-9bd5" name="Commissars (NetEA)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Comisarios: Un ejército de la Guardia Imperial puede incluir un personaje Comisario por cada 500 puntos completos del ejército. Los Comisarios no cuestan ningún punto.  • Los Comisarios pueden ser añadidos al ejército al comienzo de la batalla, antes de que ningún bando inicie el despliegue. Si el ejército incluye un Comandante en Jefe, el primer Comisario debe ser añadido a la formación del Comandante en Jefe. Los demás Comisarios pueden añadirse a otras formaciones.  • No puedes incluir más de un Comisario en cada formación. No puedes añadir Comisarios a las formaciones de Aliados Imperiales. Si tienes más Comisarios que formaciones, el exceso se pierde.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        ...
        <modifier type="set" field="description" value="Kommissare: Die Imperiale Armee darf einen Kommissarcharakter pro 500 Punkte oder einen Teil davon in der Armee enthalten. Die Kommissare kosten keine Punkte. Kommissar-Einheiten können der Armee zu Beginn der Schlacht hinzugefügt werden, bevor eine der beiden Seiten aufgestellt wird. Wenn die Armee einen Oberbefehlshaber enthält, dann muss das erste Kommissar zu dieser Formation angebracht werden. Sie dürfen nicht mehr als einen Kommissar pro Formation angeben. Sie können keinen Kommissar zu einer imperialen Verbündetenformation hinzufügen. Wenn Sie mehr Kommissare als Formationen haben, gehen alle Überschüsse verloren.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>An Imperial Guard army may include one Commissar character per 500 points, or part thereof, in the army. The Commissars do not cost any points. Commissar units may be added to the army at the start of the battle before either side sets up. If the army includes a Supreme Commander than the first Commissar must be attached to the Supreme Commander’s formation. Any further Commissars may be attached to any other formations. You may not include more than one Commissar per formation. You may not add a Commissar to an Imperial Ally formation. If you have more Commissars than formations any excess is lost.</description>
    </rule>
    <rule id="6060-0611-11f0-f16c" name="Fortified Positions (EpicUK)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Posiciones Fortificadas: Las posiciones fortificadas deben establecerse después de los objetivos, pero antes de que se desplieguen las naves espaciales y las guarniciones. Las posiciones fortificadas pueden establecerse en cualquier lugar donde un vehículo pueda desplegarse en la propia mitad de la mesa del jugador. Se puede dividir un conjunto de posiciones fortificadas como se desee (aunque ninguna sección de trincheras o campo de minas puede ser menor de 5cm x 2,5cm), siempre que se respeten las reglas de coherencia de la formación. Por ejemplo, se podrían dividir las zanjas en varias líneas, siempre y cuando haya 5cm de &quot;enlaces&quot; entre las diferentes partes de la posición. Estas posiciones fortificadas cuentan como si tuvieran un movimiento de cero. Las posiciones fortificadas no pueden ser transportadas.  • Algunas formaciones en el ejército pueden venir con un conjunto de posiciones fortificadas; estas fortificaciones se establecen al mismo tiempo que todas las demás fortificaciones del ejército y siguen las mismas reglas. Una vez desplegadas, estas fortificaciones son de terreno y ya no forman parte de la formación.  • Una vez que las posiciones fortificadas se establecen, pueden ser usadas por cualquier unidad, no sólo por las unidades para las que fueron compradas. También pueden ser capturadas y utilizadas por unidades enemigas.  • Las posiciones fortificadas no bloquean la línea de visión.  • Los búnkeres pueden tener un tamaño máximo de 6cm x 5cm. Las trincheras y los campos de minas pueden ser de hasta 50cm x 2,5cm.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Verstärkte Positionen: Verstärkte Positionen müssen nach den Zielen, aber vor dem Einsatz von Raumfahrzeugen und Garnisonen eingerichtet werden. Die verstärkten Positionen können überall dort eingerichtet werden, wo ein Fahrzeug in der eigenen Tischhälfte des Spielers eingesetzt werden kann. Sie können eine Reihe von verstärkten Positionen nach Belieben aufteilen (wobei kein Abschnitt von Gräben und Minenfeldern kleiner als 5 cm x 2,5 cm sein darf), solange die Regeln für die Kohärenz der Formation eingehalten werden. Sie können z.B. Gräben in mehrere Linien aufteilen, solange es zwischen den verschiedenen Teilen der Stellung 5 cm lange &quot;Verbindungen&quot; gibt. Diese verstärkten Positionen zählen als eine Bewegung von Null. Verstärkte Positionen dürfen nicht transportiert werden.  • Einige Formationen in der Armee können mit einer Reihe von verstärkten Positionen ausgestattet sein; diese Befestigungen werden zur gleichen Zeit wie alle anderen Befestigungen in der Armee errichtet und folgen den gleichen Regeln. Nach ihrer Errichtung sind diese Befestigungen Gelände und nicht mehr Teil der Formation.  • Einmal errichtete verstärkte Positionen können von jeder Einheit genutzt werden, nicht nur von den Einheiten, für die sie gekauft wurden. Sie können auch von feindlichen Einheiten eingenommen und genutzt werden.  • Keine verstärkten Positionen blockieren die Sichtlinie.  • Bunker können maximal 6cm x 5cm groß sein. Gräben und Minenfelder können bis zu 50 cm x 2,5 cm groß sein.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Positions Fortifiées: Les positions fortifiées doivent être établies après les objectifs, mais avant le déploiement des vaisseaux spatiaux et des garnisons. Les positions fortifiées peuvent être installées partout où un véhicule peut se déployer dans la moitié de la table du joueur. Vous pouvez diviser un ensemble de positions fortifiées comme vous le souhaitez (bien qu&apos;aucune section de tranchée ou de champ de mines ne puisse être inférieure à 5 cm x 2,5 cm), à condition de respecter les règles de cohérence de la formation. Par exemple, vous pouvez diviser les tranchées en plusieurs lignes, à condition qu&apos;il y ait des &quot;liens&quot; de 5 cm entre les différentes parties de la position. Ces positions fortifiées comptent comme ayant un mouvement de zéro. Les positions fortifiées ne peuvent pas être transportées.  • Certaines formations de l&apos;armée peuvent être dotées d&apos;un ensemble de positions fortifiées ; ces fortifications sont mises en place en même temps que toutes les autres fortifications de l&apos;armée et suivent les mêmes règles. Une fois déployées, ces fortifications sont du terrain et ne font plus partie de la formation.  • Une fois que les positions fortifiées sont installées, elles peuvent être utilisées par n&apos;importe quelle unité, et pas seulement par les unités pour lesquelles elles ont été achetées. Elles peuvent également être capturées et utilisées par des unités ennemies.  • Aucune position fortifiée ne bloque la ligne de vue.  • Les bunkers peuvent avoir une taille maximale de 6 cm x 5 cm. Les tranchées et les champs de mines peuvent mesurer jusqu&apos;à 50 cm x 2,5 cm.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Fortified positions must be set up after objectives, but before spacecraft and garrisons are deployed. The fortified positions may be set up anywhere a vehicle may deploy in the army&apos;s own half of the table. You may split up a set of fortified positions as desired (although no section of trenches or minefield may be smaller than 5cm x 2.5cm), as long as the rules for formation coherency are adhered to. For example, you could split up trenches into several lines, as long as there are 5cm ‘links’ between the different parts of the position. These fortified positions count as having a move of zero. Fortified positions may not be transported.
Some formations in the army may come with a set of fortified positions; these fortifications are set up at the same time as all other fortifications in the army and follow the same rules. Once deployed these fortifications are terrain and are no longer a part of the formation.
Once fortified positions are set up they may be used by any unit, not just the units they were purchased for. They may also be captured and used by enemy units.
No fortified positions block line of sight.
Bunkers can be a maximum of 6cm x 5cm in size. Trenches and Minefields can be up to 50cm x 2.5cm.</description>
    </rule>
    <rule id="3cbb-2959-7c15-17b9" name="Space Marine Transports (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Transports: Les formations Space Marines disposant d&apos;unités avec le suffixe &quot;+ Transports&quot; peuvent prendre assez de Rhinos pour transporter l’intégralité de la formation. Si cette option est prise, le nombre de Rhinos doit être suffisant, mais la capacité totale de transport ne doit pas être excédentaire par rapport au nombre d&apos;unités à transporter.  • Si des véhicules avec une capacité de transport ont été achetés pour la formation (comme des Razorbacks ou des Land Raiders), on considère qu’ils transportent au maximum de leurs capacités et qu’il est possible de prendre assez de Rhinos pour transporter ce qu&apos;il reste de la formation (même si un Rhino se retrouve à moitié vide).  • En outre, il est possible de remplacer tous les Rhinos de la formation par un Dreadnought ou par des Modules d’atterrissage.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transporte: Space-Marine-Formationen, die über Einheiten mit dem Suffix &quot;+ Transporte&quot; verfügen, können genügend Rhinos mitnehmen, um die gesamte Formation zu transportieren. Wenn diese Option genommen wird, muss die Anzahl der Rhinos ausreichend sein, aber die gesamte Transportkapazität darf die Anzahl der zu transportierenden Einheiten nicht überschreiten.  • Wenn für die Formation Fahrzeuge mit Transportkapazität gekauft wurden (wie Razorbacks oder Land Raiders), wird davon ausgegangen, dass sie mit maximaler Kapazität transportieren und dass genügend Rhinos genommen werden können, um den Rest der Formation zu transportieren (selbst wenn ein Rhino halb leer ist).  • Außerdem ist es möglich, alle Rhinos in der Formation durch einen Cybot ODER Landungskapseln ersetzen.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Transportes: Las formaciones de Marines Espaciales con unidades con el sufijo &quot;+ Transporte&quot; pueden llevar suficientes Rhinos para transportar toda la formación. Si se toma esta opción, el número de Rhinos debe ser suficiente, pero la capacidad total de transporte no debe superar el número de unidades a transportar.  • Si se han comprado vehículos con capacidad de transporte para la formación (como Razorbacks o Land Raiders), se considera que transportan al máximo de su capacidad y es posible llevar suficientes Rhinos para transportar el resto de la formación (aunque un Rhino acabe medio vacío).  • Además, es posible sustituir todos los Rhinos de la formación por un Dreadnought O Cápsulas de Desembarco.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Space Marine formations with units with the suffix &quot;+ Transport&quot; may take enough Rhinos to transport the entire formation. If this option is taken, the number of Rhinos must be sufficient, but the total transport capacity must not exceed the number of units to be transported.
If vehicles with transport capacity have been purchased for the formation (such as Razorbacks or Land Raiders), they are considered to be transporting at maximum capacity and it is possible to take enough Rhinos to transport the remainder of the formation (even if a Rhino ends up half empty).
In addition, it is possible to replace all the Rhinos in the formation with a Dreadnought OR Drop Pods.</description>
    </rule>
    ...
    <rule id="ee27-fe1f-8cbf-7e1b" name="Fortified Positions (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Posiciones Fortificadas: Una Posición Fortificada es un elemento de terreno del siguiente tipo:  • Trincheras/Líneas defensivas  • o Fortificación/Búnker.  • Su forma puede variar según el diseño de los maestros arquitectos, pero su superficie nunca debe permitir más unidades que las descritas por el número entre paréntesis en su códice (por ejemplo, &quot;Búnker(3)&quot; describe un búnker que puede albergar hasta 3 unidades de infantería). Si la combinación de la topología de la Posición Fortificada y las bases de las unidades no permite todas las unidades permitidas, entonces se sigue considerando que las unidades están dentro y las medidas se toman todas desde los bordes de la Posición Fortificada. La longitud total de las Posiciones Fortificadas desplegadas por una formación nunca debe exceder su número por 4cm.  • Las Posiciones Fortificadas siguen las reglas de cobertura descritas en la página 12 del libro de reglas y bloquean las líneas de visión normalmente. La alambrada que puede acompañar a las Posiciones Fortificadas sigue las mismas reglas pero no bloquea las líneas de visión, su longitud total no debe superar la de las Posiciones Fortificadas y se desplegará al mismo tiempo.  • El valor estratégico más alto decide qué jugador despliega su primer conjunto de Posiciones Fortificadas en su turno. Las Posiciones Fortificadas deben colocarse después de los Objetivos, pero antes de que se desplieguen las Naves Espaciales y las Guarniciones. Pueden colocarse en cualquier lugar donde pueda estar un vehículo, en la mitad de la mesa del jugador activo. Aunque son elementos de terreno, las Posiciones Fortificadas deben seguir las reglas de cohesión de la formación entre ellas (por ejemplo, puedes dividir las trincheras en varios elementos, siempre que haya un espacio máximo de 5cm entre cada elemento). La Alambrada no tiene que colocarse en cohesión con tus Posiciones Fortificadas, pero debe respetar la cohesión entre ellas.  • Una vez colocadas, las Posiciones Fortificadas se consideran un elemento de terreno neutral y cualquier unidad que tenga la capacidad de terminar su movimiento dentro de ellas puede ocuparlas.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Verstärkte Positionen: Eine befestigte Stellung ist ein Geländemerkmal der folgenden Art:  • Schützengräben/Verteidigungslinien  • oder Festung/Bunker.  • Ihre Form kann je nach Entwurf der Baumeister variieren, aber ihre Fläche darf niemals mehr Einheiten aufnehmen, als durch die Zahl in Klammern im Codex beschrieben sind (z.B. &quot;Bunker(3)&quot; beschreibt einen Bunker, der bis zu 3 Infanterieeinheiten aufnehmen kann). Wenn die Kombination aus der Topologie der befestigten Stellung und den Einheitenbasen nicht alle erlaubten Einheiten zulässt, dann werden die Einheiten immer noch als im Inneren befindlich betrachtet und die Messungen werden alle von den Kanten der befestigten Stellung aus vorgenommen. Die Gesamtlänge der befestigten Stellungen, die eine Formation errichtet, sollte niemals die Anzahl mal 4 cm überschreiten.  • Befestigte Stellungen folgen den Regeln für Deckung, wie sie auf Seite 12 des Regelbuchs beschrieben sind, und blockieren die Sichtlinien normal. Der Stacheldraht, der befestigte Stellungen begleiten kann, folgt denselben Regeln, blockiert aber nicht die Sichtlinien, seine Gesamtlänge darf die der befestigten Stellungen nicht überschreiten und er wird gleichzeitig aufgestellt.  • Der höchste strategische Wert entscheidet, welcher Spieler sein erstes Set befestigter Stellungen aufstellt. Befestigte Stellungen müssen nach den Zielen, aber vor der Aufstellung von Raumschiffen und Garnisonen aufgestellt werden. Sie können überall dort platziert werden, wo sich ein Fahrzeug befinden könnte, und zwar in der Tischhälfte des aktiven Spielers. Obwohl es sich um Geländeteile handelt, müssen befestigte Stellungen den Regeln für den Zusammenhalt der Formation folgen (z.B. können Schützengräben in mehrere Elemente unterteilt werden, solange zwischen den einzelnen Elementen ein Abstand von maximal 5 cm besteht). Der Stacheldraht muss nicht im Zusammenhalt mit den befestigten Stellungen platziert werden, aber er muss den Zusammenhalt zwischen den Stellungen respektieren.  • Einmal aufgestellt, gelten befestigte Stellungen als neutrales Geländeteil und jede Einheit, die ihre Bewegung innerhalb der Stellungen beenden kann, darf sie besetzen.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Positions Fortifiées: Une Position Fortifiée est un élément de terrain du type suivant:  • Tranchées/Lignes de défense  • ou Fortification/Bunker.  • Leur forme peut varier selon la conception des maîtres architectes, mais leur surface ne doit jamais permettre d&apos;accueillir plus d&apos;unités tel que décrit par le nombre entre parenthèses dans leur codex (par exemple “Bunker(3)” décrit un bunker pouvant accueillir 3 unités d&apos;infanterie au maximum). Si la combinaison de la topologie de la Position Fortifiée et des socles des unités ne permet de contenir toutes les unités autorisées, alors ces dernières seront tout de même considérées comme à l&apos;intérieur et les mesures se feront toutes depuis les bords de la Position Fortifiée. La longueur totale des Positions Fortifiées déployées par une formation ne devra jamais excéder son nombre de fois 4cm.  • Les Positions Fortifiées suivent les règles de couvert tel que décrit page 12 du livre de règle et bloquent les lignes de vue normalement. Les Barbelés pouvant accompagner les Positions Fortifiées suivent les mêmes règles mais ne bloquent pas les lignes de vue et leur longueur totale ne doit pas excéder celle des Positions Fortifiées et seront déployées au même moment.  • Le joueur ayant la valeur stratégique la plus forte décide quel joueur déploie son premier set de Positions Fortifiées en alternance. Les Positions Fortifiées doivent être placées après les Objectifs, mais avant que les Vaisseaux Spatiaux et les Garnisons ne se déploient. Elles peuvent être placées partout où pourrait l&apos;être un véhicule, dans la moitié de table du joueur actif. Bien qu&apos;elles soient des éléments de terrains, les Positions Fortifiées doivent respecter les règles de cohésion de formation entre elles (par exemple, vous pouvez diviser les tranchées en plusieurs éléments, du moment qu&apos;il y a un espace maximum de 5cm entre chaque élément). Les Barbelés n’ont pas à être disposés en cohésion avec vos Positions Fortifiées, mais doivent respecter la cohésion entre eux.  • Une fois positionnées, les Positions Fortifiées sont considérées comme un élément de terrain neutre et toute unité ayant la capacité à finir son mouvement à l&apos;intérieur pourra l&apos;occuper.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>A Fortified Position is a terrain feature of the following type:
Trenches/Defensive Lines,
or Fortification/Bunker.
Their shape may vary according to the design of the master architects, but their surface area must never allow for more units as described by the number in brackets in their codex (e.g. &quot;Bunker(3)&quot; describes a bunker that can accommodate up to 3 infantry units). If the combination of the topology of the Fortified Position and the unit bases does not allow for all the units allowed, then the units are still considered to be inside and the measurements are all taken from the edges of the Fortified Position. The total length of Fortified Positions deployed by a formation should never exceed its number times 4cm.
Fortified Positions follow the rules for cover as described on page 12 of the rulebook and block lines of sight normally. The Razor Wire that may accompany Fortified Positions follows the same rules but does not block lines of sight, its total length must not exceed that of the Fortified Positions and it will be deployed at the same time.
The highest strategic value decides which player deploys his first set of Fortified Positions in turn. Fortified Positions must be placed after Objectives, but before Spaceships and Garrisons are deployed. They may be placed anywhere a vehicle could be, in the active player&apos;s half of the table. Although they are terrain elements, Fortified Positions must follow the rules for formation cohesion between them (for example, you can divide trenches into several elements, as long as there is a maximum space of 5cm between each element). The Razor Wire does not have to be placed in cohesion with your Fortified Positions, but must respect the cohesion between them.
Once positioned, Fortified Positions are considered a neutral terrain element and any unit that has the ability to finish its movement inside them may occupy them.</description>
    </rule>
    <rule id="7338-851b-bc75-8048" name="Commissars (F-ERC)" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Commissaires: Pour chaque Compagnie qu&apos;inclut votre armée, un commissaire y est automatiquement intégré.  • De plus, vous pouvez ajouter gratuitement un commissaire dans une Formation d&apos;Appui pour chaque tranche (même incomplète) de 1.000 points dans votre armée hors formations de support.  • Une compagnie ou une formation ne peut avoir qu&apos;un seul commissaire.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Kommissare: Ein Kommissar wird automatisch zu jeder Kompanie in deiner Armee hinzugefügt.  • Außerdem kannst du pro angefangene 1.000 Punkte in deiner Armee einen Kommissar kostenlos zu einer Unterstützungsformation hinzufügen, ausgenommen Flotten- und Titanenformationen.  • Eine Kompanie oder Formation kann nur einen Kommissar haben.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Comisarios: Un comisario se añade automáticamente a cada compañía de tu ejército.  • Además, por cada 1.000 puntos o parte de ellos en tu ejército, puedes añadir un comisario a una formación de apoyo de forma gratuita, excluyendo las formaciones de flota y de titanes.  • Una compañía o formación sólo puede tener un Comisario.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>A Commissar is automatically added to each Company in your army.
In addition, for every 1,000 points or part thereof in your army, you can add a Commissar to a Support Formation for free, excluding Fleet and Titan Formations.
A company or formation can only have one Commissar.</description>
    </rule>
    <rule id="7242-606c-d04e-7af5" name="Animalistic" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Animalística: Pueden disputar objetivos, pero no controlarlos.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Animale: Peuvent contester les objectifs mais pas les tenir.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Animalisch: Kann Ziele anfechten, aber keine Ziele halten.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
