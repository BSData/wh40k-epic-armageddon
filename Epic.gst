...
6: The creature is instantly killed.</description>
    ...
    <rule id="6791-edda-a014-7566" name="Rules for Daemons of All Types" hidden="false">
      <modifiers>
        <modifier type="set" field="description" value="Règles des Démons de Tous Types: Sacrifiables : Les unités Sacrifiables ne génèrent pas de pion impact lorsqu&apos;elles sont détruites. Cependant, les unités Sacrifiables comptent dans le calcul des pertes lors de la résolution d&apos;un assaut.  • Les démons mineurs sont tous sacrifiables.  • Instable : Si les démons sont démoralisés, ils sont détruits.  • Ils ne peuvent que contester les objectifs, pas les contrôler.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="798a-d9b8-47b6-c74c" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Regeln für Dämonen aller Art: Opferbereitschaft: Opfereinheiten erzeugen keinen Blast-Marker, wenn sie zerstört werden. Opfereinheiten zählen jedoch bei der Berechnung von Verlusten bei der Lösung eines Angriffs. Die kleineren Dämonen sind alle opferbar.  • Instabil: Wenn die Dämonen zerbrochen sind, werden sie zerstört.  • Darf Ziele nur herausfordern, nicht kontrollieren.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="8220-3d37-43f7-71e8" type="equalTo"/>
          </conditions>
        </modifier>
        <modifier type="set" field="description" value="Reglas para los Demonios de Todos los Tipos: Sacrificable: Las unidades sacrificables no generan un marcador de explosión cuando son destruidas. Sin embargo, las unidades que se sacrifican cuentan en el cálculo de pérdidas cuando se resuelve un asalto. Los demonios menores son todos sacrificables.  • Inestable: Si los demonios están desmoralizados, son destruidos.  • Sólo pueden disputar objetivos, no controlarlos.">
          <conditions>
            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="3715-341b-881c-9c4c" type="equalTo"/>
          </conditions>
        </modifier>
      </modifiers>
      <description>Sacrificial units do not generate a blast marker when destroyed. However, Sacrificial units do count towards the casualty calculation when resolving an assault. Lesser daemons are all expendable.
